"""AWS Bedrock Converse API adapter for 3V0 Agent.
...
def _require_boto3():
    ...
    try:
        ...
        raise ImportError(
            ...
            "Or install 3V0 with Bedrock support: pip install -e '.[bedrock]'"
        )
    # converse() / converse_stream() were added in boto3 1.34.59.
    # When 3V0 is installed editable into system Python, the system boto3

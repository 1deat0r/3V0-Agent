...
def build_subscription_state(*, timeout: float = 15.0) -> SubscriptionState:
    ...
    Dev override: when ``EV0_DEV_SUBSCRIPTION_FIXTURE`` names a fixture state,
...
def dev_fixture_subscription_state() -> Optional[SubscriptionState]:
    """Return a fixture :class:`SubscriptionState` for ``EV0_DEV_SUBSCRIPTION_FIXTURE``.
    ...
    return SubscriptionState(logged_in=False, error=f"unknown EV0_DEV_SUBSCRIPTION_FIXTURE: {name}")

...
# ``data:`` field before 3V0 receives a completion chunk.  Keeping this
...
# case: a stream dies mid-response and 3V0 persists a content-less
...
def classify_api_error(
    ...
    *,
    ...
    # threev0_cli.plugins.VALID_HOOKS for the callback contract). Callback
    ...
    try:
        from threev0_cli.plugins import get_plugin_error_classification

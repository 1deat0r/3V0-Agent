"""Vertex AI (Google Cloud) adapter for 3V0 Agent.

Provides authentication and configuration for Vertex AI's OpenAI-compatible
endpoint. This allows 3V0 to use Gemini models via Google Cloud with
...
# who installed plain `3v0-agent` and only later selected a Gemini model.
try:

...
# heuristics. See https://github.com/NousResearch/3v0-agent/issues/38389
#
...
#   ev0_cli/oneshot.py no-user callback.
...
Summary generation was unavailable, so this is a best-effort deterministic fallback for {len(turns_to_summarize)} compacted message(s).{reason_text}"""
    ...
    def _generate_summary(
        ...
        # user's configured timezone via ev0_time.now(). The compaction summary

...
def _clamp_responses_call_id(call_id: str) -> str:
    ...
    component the built-in ``3v0-tools`` server already overflows 64 chars,
...
# output items.  3V0 injects xAI's native ``web_search`` for the xAI
...
# server-assigned base64 blobs that can run 400+ chars, while 3V0-minted
...
def _chat_messages_to_responses_input(
    ...
    *,
    ...
    explicitly relies on 3V0 threading encrypted reasoning back across
    ...
    ``convert_messages``). Dropping the checkpoint costs nothing: 3V0'
                ...
                if isinstance(codex_reasoning, list):
                    for ri in codex_reasoning:
                        if isinstance(ri, dict) and ri.get("encrypted_content"):
                            ...
                            # it is a 3V0-side metadata key and not part
...
def _normalize_codex_response(
    ...
    *,
    ...
    if tool_calls:
        ...
        # See https://github.com/NousResearch/3v0-agent/issues/64434

"""Language Server Protocol (LSP) integration for 3V0 Agent.

3V0 runs full language servers (pyright, gopls, rust-analyzer,
...
def get_service() -> Optional[LSPService]:
    ...
    with _service_lock:
        ...
        if not _atexit_registered:
            ...
            # ``3v0 chat`` exit would leak pyright processes that

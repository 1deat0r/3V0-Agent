...
row taxonomy is inferred from the atlas shape so 3V0 can render both legacy
...
# rows (1536x1872), while older 3V0/petdex sheets used 9 columns x 8 rows
...
class PetState(str, Enum):
    ...
    These are 3V0' activity state names. They are not always identical to the
...
# Legacy 3V0/petdex row order (top -> bottom) used by the older 8-row,
...
# Canonical 3V0 activity names -> accepted row-name aliases in descending

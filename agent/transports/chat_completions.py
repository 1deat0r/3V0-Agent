...
def _build_gemini_thinking_config(model: str, reasoning_config: dict | None) -> dict | None:
    """Translate 3V0/OpenRouter-style reasoning config to Gemini thinkingConfig."""
    ...
    # Gemini 2.5 accepts thinkingBudget; don't guess a budget from 3V0'
    ...
    # is stricter (low/high). Clamp 3V0' wider effort set to what each
...
def _raise_gemini_thinking_max_tokens(
    ...
    global 3V0 cap of 4096 is enough for visible text, but Ultra/high
...
class ChatCompletionsTransport(ProviderTransport):
    ...
    def convert_messages(
        ...
        - 3V0-internal scaffolding markers — any top-level message key
        ...
        for msg_idx, msg in enumerate(messages):
            ...
            # Drop all 3V0-internal scaffolding markers (``_``-prefixed).

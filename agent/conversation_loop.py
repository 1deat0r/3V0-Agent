...
# Must mirror _STALE_TOOL_CALL_MARKER_RE in threev0_state.py — kept local
# to avoid importing threev0_state at module load time (its module-level
...
from threev0_constants import PARTIAL_STREAM_STUB_ID
...
def run_conversation(
    ...
    # 'disk', or 'unknown' — see threev0_state.classify_persistence_error).
    ...
    while (api_call_count < agent.max_iterations and agent.iteration_budget.remaining > 0) or agent._budget_grace_call:
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                try:
                    from threev0_cli.middleware import apply_llm_request_middleware
                ...
                try:
                    from threev0_cli.lifecycle import (
                        has_hook,
                ...
                from threev0_cli.middleware import run_llm_execution_middleware
                ...
                if getattr(api_error, "status_code", None) == 404:
                    try:
                        from threev0_cli.model_normalize import suggest_prefixed_model_id
        ...
        try:
            ...
            if assistant_message.tool_calls:
                ...
                try:
                    ...
                    from threev0_cli.plugins import get_pre_verify_continue_message

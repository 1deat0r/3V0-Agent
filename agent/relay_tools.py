"""Core NeMo Relay adapter for 3V0 tool execution."""
...
def _run_awaitable(value: Any) -> Any:
    ...
    raise RuntimeError(
        "Synchronous 3V0 Relay tool execution cannot run on an active event-loop thread"
    )

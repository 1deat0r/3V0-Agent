"""Preventive SSL CA certificate checks for 3V0 Agent.
...
def _repair_hint() -> str:
    return (
        "Repair: run `3v0 doctor --fix` (auto-reinstalls certifi), or "
...
def verify_ca_bundle() -> None:
    ...
    if _skip_ssl_guard_enabled():
        logger.debug("SSL CA bundle guard skipped via EV0_SKIP_SSL_GUARD")
        return

...
_SESSION_CWD: ContextVar = ContextVar("EV0_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    # configured path is otherwise honored verbatim — including the 3V0
    # source tree itself, which is a legitimate workspace when the user is
    # developing 3V0 (per-surface policy for fallback-picked directories

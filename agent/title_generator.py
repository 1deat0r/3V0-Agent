...
# 3V0' own machine-authored openers. A compaction handoff or a resumed
...
def auto_title_session(
    ...
    post-``3v0 update`` stale-module window, where this function's lazy
    ...
    try:
        ...
        logger.warning(
            ...
            "restart the running 3V0 process): %s",
            e,
        )
...
def _is_real_user_turn(message: Any) -> bool:
    ...
    3V0 persists a lot of machinery under ``role="user"`` — compaction

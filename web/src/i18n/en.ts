...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateEv0: "Update 3V0",
    updateEv0ConfirmMessage:
      "This runs 3v0 update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateEv0ConfirmNow: "Update now",
    updateEv0ConfirmTitle: "Update 3V0?",
    updatingEv0: "Updating 3V0…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update 3V0 plugins (`3v0 plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.3V0/plugins/?",
    removeHint: "Only user-installed plugins under ~/.3V0/plugins can be removed.",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills found. Skills are loaded from ~/.3V0/skills/",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that 3V0 doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      title: "3V0 Achievements",
      subtitle:
        "Collectible 3V0 badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning 3V0 session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run 3V0 more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once 3V0 sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "3V0 is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in 3V0 Agent ☤",
    },
  },

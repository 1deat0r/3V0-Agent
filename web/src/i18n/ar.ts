...
export const ar = defineLocale({
  ...
  pluginsPage: {
    ...
    headline:
      "اكتشف وثبِّت وفعِّل وحدِّث مكوِّنات 3V0 الإضافية (مطابقة `3v0 plugins`).",
    ...
    removeConfirm: "إزالة هذا المكوِّن الإضافي من ~/.3V0/plugins/؟",
    removeHint: "يمكن إزالة المكوِّنات المثبتة من المستخدم تحت ~/.3V0/plugins فقط.",
  ...
  skills: {
    ...
    categories: "الفئات",
    filters: "الفلاتر",
    noSkills: "لم يُعثر على مهارات. يتم تحميل المهارات من ~/.3V0/skills/",
  ...
  achievements: {
    hero: {
      ...
      title: "إنجازات 3V0",
      subtitle:
        "شارات 3V0 قابلة للجمع مكتسبة من سجل الجلسات الفعلي. الإنجازات غير المكتملة المعروفة تُعرض كـ Discovered؛ تبقى الإنجازات السرية مخفية حتى يظهر السلوك المطابق لأول مرة.",
      scan_subtitle:
        "فحص سجل جلسات 3V0. يمكن أن يستغرق الفحص الأول 5–10 ثوانٍ على السجلات الكبيرة.",
    },
    actions: {
      rescan: "إعادة الفحص",
    },
    stats: {
      ...
      latest: "الأحدث",
      latest_hint_empty: "شغِّل 3V0 أكثر",
    ...
    guide: {
      ...
      secret_body:
        "تخفى الأسرار محددها الدقيق. بمجرد أن ترى 3V0 إشارة ذات صلة، تصبح البطاقة مكتشفة وتعرض متطلباتها.",
      scan_status_header: "حالة الفحص",
      scan_status_body:
        "تُفحص 3V0 السجل المحلي مرة واحدة، ثم تظهر البطاقات تلقائيًا. لا يوجد توقف إذا استغرق هذا بضع ثوانٍ.",
    ...
    share: {
      ...
      tweet_text: "فتحت للتو {tier_part}\"{name}\" في 3V0 Agent ☤"
    },
  },

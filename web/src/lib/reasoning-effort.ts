 ...
 *
 * Values mirror threev0_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the 3V0 default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (3V0' default when unset). */

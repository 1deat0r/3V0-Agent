 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `threev0_cli/web_server.py`.
 */
...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "3V0 Teal",
  description: "Classic dark teal — the canonical 3V0 look",
  palette: {
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "3V0 Teal (Large)",
  description: "3V0 Teal with bigger fonts and roomier spacing",

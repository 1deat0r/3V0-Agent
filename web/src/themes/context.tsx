...
const STORAGE_KEY = "3v0-dashboard-theme";
...
const FONT_STORAGE_KEY = "3v0-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `threev0_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "3v0-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-3v0-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-3v0-theme-font", "true");

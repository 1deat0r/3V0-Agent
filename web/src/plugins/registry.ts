 ...
 *
 * Plugins call window.__EV0_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__EV0_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__EV0_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__EV0_PLUGIN_SDK__ = {
    ...
    // window.__EV0_SESSION_TOKEN__ directly.
    authedFetch,

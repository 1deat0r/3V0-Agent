 ...
 * `window.__EV0_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the 3V0 brand in the top bar
 ...
 *  `window.__EV0_PLUGINS__.registerSlot(...)`.
 *

/**
 * 3V0 Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__EV0_PLUGIN_SDK__`` and
 * ``window.__EV0_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__EV0_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``Ev0PluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@3v0/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__EV0_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__EV0_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__EV0_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface Ev0PluginSDK {
...
declare global {
  interface Window {
    __EV0_PLUGIN_SDK__?: Ev0PluginSDK;
    __EV0_PLUGINS__?: PluginRegistry;
  }
}

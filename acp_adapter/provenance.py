...
def build_session_provenance(
    ...
    *,
    ...
    """
    try:
        row = db.get_session(current_ev0_session_id)
    except Exception:
        return None
    if not row:
        return None
    ...
    root_id = current_ev0_session_id
    compression_depth = 0
    cursor_parent = parent_id
    seen = {current_ev0_session_id}
    ...
    rotated = bool(
        ...
        and previous_ev0_session_id != current_ev0_session_id
    )

    provenance: Dict[str, Any] = {
        "acpSessionId": acp_session_id,
        "currentEv0SessionId": current_ev0_session_id,
    ...
    if previous_ev0_session_id:
        provenance["previousEv0SessionId"] = previous_ev0_session_id
    if rotated:

"""ACP permission bridging for 3V0 dangerous-command approvals."""
...
# Maps ACP permission option ids to 3V0 approval result strings.
...
def _build_permission_options(
    *, allow_permanent: bool, smart_denied: bool = False,
    ...
    """Return ACP options that match 3V0 approval semantics."""
    ...
    if not smart_denied:
        options.append(PermissionOption(
            ...
            # hint while keeping 3V0 semantics in the option id.
            kind="allow_always",
...
def _map_outcome_to_ev0(outcome: object, *, allowed_option_ids: set[str]) -> str:
    """Map an ACP permission outcome into 3V0 approval strings."""
    ...
    if option_id not in allowed_option_ids:
        ...
        return "deny"
    return _OPTION_ID_TO_EV0.get(option_id, "deny")
...
def make_approval_callback(
    ...
    """
    Return a 3V0-compatible approval callback that bridges to ACP.

...
Invoked by ``3v0 kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the 3V0 Agent board.
...
def _profile_author() -> str:
    """Mirror of ``ev0_cli.kanban._profile_author``."""
    return (

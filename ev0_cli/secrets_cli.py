...
# this module is registered parse-time from ``ev0_cli.main`` and must not
...
def __getattr__(name: str):
    ...
    ``ev0_cli.secrets_cli.bw`` directly.  Resolving that attribute at
    ...
    the first actual attribute access, so ``import ev0_cli.secrets_cli``

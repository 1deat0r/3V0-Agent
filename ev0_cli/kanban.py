...
from ev0_cli import kanban_swarm as ks
...
def kanban_command(args: argparse.Namespace) -> int:
    ...
    # ev0_cli.kanban_db, because children can import DB mutators directly.
...
def _cmd_show(args: argparse.Namespace) -> int:
    ...
    # comments / runs.
    from ev0_cli import kanban_diagnostics as kd
...
def _cmd_specify(args: argparse.Namespace) -> int:
    ...
    from ev0_cli import kanban_specify as spec
...
def _cmd_decompose(args: argparse.Namespace) -> int:
    ...
    from ev0_cli import kanban_decompose as decomp

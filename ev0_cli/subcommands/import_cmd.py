...
def build_import_cmd_parser(subparsers, *, cmd_import: Callable) -> None:
    ...
    import_parser = subparsers.add_parser(
        "import",
        help="Restore a 3V0 backup from a zip file",
        description="Extract a previously created 3V0 backup into your "
        "3V0 home directory, restoring configuration, skills, "
        "sessions, and data",
    )

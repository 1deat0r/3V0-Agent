...
def build_setup_parser(subparsers, *, cmd_setup: Callable) -> None:
    ...
    setup_parser = subparsers.add_parser(
        ...
        description="Configure 3V0 Agent with an interactive wizard. "
        "Run a specific section: "
        "3v0 setup model|tts|terminal|gateway|tools|telemetry|agent",
    )
    ...
    setup_parser.add_argument(
        ...
        "compatibility — a bare '3v0 setup' now does this.",
    )
    setup_parser.add_argument(
        "--quick",
        action="store_true",

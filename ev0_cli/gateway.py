...
# when ev0_constants is cached from a pre-update version during `hermes update`.
...
def get_python_path() -> str:
    ...
    if venv is not None:
        try:
            ...
            # _reload_hermes_constants() in ev0_cli/managed_uv.py.
            from ev0_cli.managed_uv import _reload_hermes_constants

...
late-binding seam in :mod:`ev0_cli.web_deps` so tests that
...
async def update_profile_soul(name: str, body: ProfileSoulUpdate):
    ...
    try:
        ...
        # profiles seed SOUL.md at the umask default (ev0_cli.profiles
...
async def describe_profile_auto_endpoint(name: str, body: ProfileDescribeAuto):
    ...
    try:
        from ev0_cli import profile_describer

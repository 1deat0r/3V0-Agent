...
late-binding seam in :mod:`ev0_cli.web_deps` (``late`` for callables,
...
from ev0_cli.web_deps import late, LateState
from ev0_cli.web_models import (
...
_log = logging.getLogger("ev0_cli.web_server")
...
async def get_toolsets(profile: Optional[str] = None):
    ...
    from ev0_cli.platforms import platform_label

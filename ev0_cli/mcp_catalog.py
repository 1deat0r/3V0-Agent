...
from ev0_constants import get_ev0_home, get_optional_mcps_dir
...
from ev0_cli.cli_output import prompt as _prompt_input
...
def _parse_manifest(path: Path) -> CatalogEntry:
    ...
    if t_type == "http" and a_type == "api_key":
        ...
        # at connect time.
        from ev0_cli.mcp_config import _env_key_for_server
...
def _build_server_config(
    ...
    if t.type == "stdio":
        ...
        if entry.auth.type == "oauth":
            ...
            from ev0_cli.mcp_config import _bearer_auth_headers
...
def _probe_tools(name: str) -> Optional[List[tuple]]:
    ...
    try:
        ...
        from ev0_cli.mcp_config import _probe_single_server
...
def install_entry(entry: CatalogEntry, *, enable: bool = True) -> None:
    ...
    from ev0_cli.mcp_config import _save_mcp_server

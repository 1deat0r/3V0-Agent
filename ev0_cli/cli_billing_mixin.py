...
Import discipline mirrors ``ev0_cli.cli_commands_mixin``:
...
class CLIBillingMixin:
    ...
    def _open_url_in_browser(self, url: str) -> bool:
        ...
        use (``ev0_cli.auth``): ``webbrowser.open()`` returns ``True`` even when
    ...
    def _subscription_preview_and_confirm(self, state, tier_id, *, allow_stepup=True):
        ...
        from ev0_cli.nous_billing import BillingError, BillingScopeRequired, post_subscription_preview
    ...
    def _subscription_handle_scope_required(self, state, *, retry, idempotency_key=None):
        ...
        try:
            from ev0_cli import nous_billing as _nb

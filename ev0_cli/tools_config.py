...
from ev0_cli.nous_subscription import (
    MANAGED_FEATURE_COVERAGE_CATEGORY,
    NousSubscriptionFeatures,
    apply_nous_managed_defaults,
    get_nous_subscription_features,
)
from ev0_cli.nous_account import format_nous_portal_entitlement_message
...
def _post_setup_no_window_flags(*, streams_to_console: bool = False) -> int:
    ...
    :func:`ev0_cli._subprocess_compat.windows_hide_flags`) suppresses it
...
from ev0_cli.cli_output import (  # noqa: E402 — late import block
...
def _xai_credentials_present() -> bool:
    ...
    """
    try:
        from ev0_cli.auth import _read_xai_oauth_tokens
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from ev0_cli.plugins import discover_plugins, get_plugin_toolsets
...
def _get_plugin_toolset_keys() -> set:
    ...
    try:
        from ev0_cli.plugins import get_plugin_toolset_keys_nowait
...
from ev0_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
...
def _run_post_setup(post_setup_key: str):
    ...
    if post_setup_key in {"agent_browser", "browserbase"}:
        ...
        try:
            from ev0_cli.auth import login_spotify_command
        except Exception as exc:
        ...
        try:
            from ev0_cli.plugins_cmd import _get_enabled_set, _save_enabled_set
...
def _agent_browser_installed() -> bool:
    ...
    from ev0_cli.nous_subscription import _local_browser_runnable
...
def _cloud_agent_browser_installed() -> bool:
    ...
    from ev0_cli.nous_subscription import _has_agent_browser
...
# Kept in sync with the dashboard selects (ev0_cli/web_server.py

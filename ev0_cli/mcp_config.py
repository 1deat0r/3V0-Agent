...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from ev0_cli.cli_output import prompt as _shared_prompt
...
def cmd_mcp_add(args):
    ...
    # ev0_cli/main.py for why the dest is renamed.
...
def mcp_command(args):
    ...
    if action == "picker":
        from ev0_cli.mcp_picker import run_picker
        run_picker()
        return
    if action == "catalog":
        from ev0_cli.mcp_picker import show_catalog
        show_catalog()
        return
    if action == "install":
        from ev0_cli.mcp_picker import install_by_name
        import sys as _sys

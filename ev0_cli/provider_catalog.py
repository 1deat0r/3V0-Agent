...
they were not: the CLI picker read :data:`ev0_cli.models.CANONICAL_PROVIDERS`
...
* ``auth_type`` / ``api_key_env_vars`` / ``base_url_env_var`` from
  :data:`ev0_cli.auth.PROVIDER_REGISTRY` (credential truth), and
...
# ev0_cli.auth.PROVIDER_REGISTRY and providers.base.ProviderProfile.

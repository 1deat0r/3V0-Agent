...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your 3V0 session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show 3V0 session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running 3V0 agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update 3V0 Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the 3V0 gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a 3V0 session in it",

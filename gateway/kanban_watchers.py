...
def _kanban_dispatch_allowed() -> bool:
    """Return False while the global emergency stop (`3v0 pause`) is engaged.
...
class GatewayKanbanWatchersMixin:
        ...
        while self._running:
            try:
                ...
                def _collect():
                    ...
                    # EV0_KANBAN_DB pins the board path; without this guard
    ...
    async def _kanban_dispatcher_watcher(self) -> None:
        ...
        no separate `3v0 kanban daemon` process needed. When false, the
        ...
        # watcher here. Honours EV0_KANBAN_DISPATCH_IN_GATEWAY env var
            ...
            try:
                ...
                if _is_corrupt_board_db_error(exc):
                    ...
                    logger.error(
                        ...
                        "then run `3v0 kanban init` if you need a fresh board.",
                        slug,
                        fingerprint[0],
                    )
                    return None
        ...
        def _ready_nonempty() -> bool:
            ...
            task on ANY board whose assignee maps to a real 3V0 profile
            ...
            PATH, missing venv, credential loss for a real 3V0 profile).
            """
        ...
        def _auto_decompose_tick(auto_decompose_per_tick: int) -> int:
            ...
            """
            try:
                from threev0_cli import kanban_decompose as _decomp
        ...
        while self._running:
            ...
            try:
                # Global emergency stop (`3v0 pause`): skip auto-decompose

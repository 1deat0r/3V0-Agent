...
def _thread_metadata_for_source(source, reply_to_message_id: str | None = None) -> dict | None:
    ...
    value. Telegram private-chat topics created through 3V0' DM-topic helper
...
def _reply_anchor_for_event(event) -> str | None:
    ...
    replying to the triggering message. 3V0-created Telegram private-chat
...
def build_auto_tts_output_path(platform) -> str:
    ...
    TTS tool's ``EV0_SESSION_PLATFORM`` contextvar — that contextvar is
...
# Policy modules (#22 expand): re-exported so `gateway.platforms.base.X`
# import paths keep working. Implementation lives in gateway/platforms/policy/.
from gateway.platforms.policy.inbound_media import DEFAULT_INBOUND_MEDIA_MAX_BYTES, _read_httpx_body_with_limit, get_inbound_media_max_bytes, validate_inbound_media_size  # noqa: F401,E402
from gateway.platforms.policy.media_types import MEDIA_DELIVERY_EXTS, MEDIA_EXTENSIONLESS_TAG_RE, MEDIA_TAG_CLEANUP_RE, SUPPORTED_DOCUMENT_TYPES, SUPPORTED_IMAGE_DOCUMENT_TYPES, SUPPORTED_VIDEO_TYPES, _AUDIO_EXTS, _AUDIO_MIME_TYPES, _MEDIA_CJK_TERMINATORS, _MEDIA_EXT_ALTERNATION, _TELEGRAM_AUDIO_ATTACHMENT_EXTS, _TELEGRAM_VOICE_EXTS, _TEXT_INJECT_EXTENSIONS  # noqa: F401,E402
from gateway.platforms.policy.net import _LOG_UNSAFE_CHARS, _detect_macos_system_proxy, _log_safe_path, _no_proxy_entries, _no_proxy_entry_matches, _split_host_port, _ssrf_redirect_guard, is_host_excluded_by_no_proxy, is_network_accessible, proxy_kwargs_for_aiohttp, proxy_kwargs_for_bot, resolve_proxy_url, safe_url_for_log, should_bypass_proxy  # noqa: F401,E402
from gateway.platforms.policy.streaming_tts import AudioFormat, StreamingTTSHandle, streaming_tts_should_skip_whole_file, streaming_tts_turn_key  # noqa: F401,E402
from gateway.platforms.policy.media_store import AUDIO_CACHE_DIR, CachedMedia, DOCUMENT_CACHE_DIR, IMAGE_CACHE_DIR, SCREENSHOT_CACHE_DIR, VIDEO_CACHE_DIR, _CACHE_DIR_IMPORT_DEFAULTS, _cleanup_cache_dir, _looks_like_image, _resolve_cache_dir, _resolve_media_ext, _sniff_audio_ext, cache_audio_from_bytes, cache_audio_from_url, cache_document_from_bytes, cache_image_from_bytes, cache_image_from_url, cache_media_bytes, cache_video_from_bytes, cleanup_audio_cache, cleanup_document_cache, cleanup_image_cache, cleanup_screenshot_cache, cleanup_video_cache, get_audio_cache_dir, get_document_cache_dir, get_image_cache_dir, get_screenshot_cache_dir, get_video_cache_dir  # noqa: F401,E402
from gateway.platforms.policy.media_delivery import MEDIA_DELIVERY_ALLOW_DIRS_ENV, MEDIA_DELIVERY_SAFE_ROOTS, MEDIA_DELIVERY_STRICT_ENV, MEDIA_DELIVERY_TRUST_RECENT_ENV, MEDIA_DELIVERY_TRUST_RECENT_SECONDS_ENV, _EV0_HOME, _EV0_ROOT, _MEDIA_DELIVERY_CACHE_SUBDIRS, _MEDIA_DELIVERY_DENIED_HOME_SUBPATHS, _MEDIA_DELIVERY_DENIED_PREFIXES, _MEDIA_DELIVERY_TRUST_RECENT_DEFAULT_SECONDS, _cache_dir_container_mounts, _default_docker_workspace_host_root, _docker_persistent_home_host_root, _file_is_recently_produced, _kanban_attachment_roots, _match_extensionless_path, _media_delivery_allowed_roots, _media_delivery_denied_paths, _media_delivery_recency_seconds, _media_delivery_strict_mode, _merge_spans, _normalize_media_tag_path, _parse_docker_volume_mounts, _path_is_within, _path_lacks_deliverable_extension, _path_under_denied_prefix, _profile_cache_roots, _resolve_extensionless_candidate, _strip_media_tag_directives, _translate_docker_container_media_path, validate_media_delivery_path  # noqa: F401,E402
...
GATEWAY_SECRET_CAPTURE_UNSUPPORTED_MESSAGE = (
    ...
    "Load this skill in the local CLI to be prompted, or add the key to ~/.3V0/.env manually."
)
...
_PLAINTEXT_GATEWAY_RESTART_PATTERNS: tuple[re.Pattern[str], ...] = (
    ...
    re.compile(r"^(?:please\s+)?restart\s+(?:the\s+)?3v0\s+gateway[.!?\s]*$", re.IGNORECASE),
    re.compile(r"^(?:please\s+)?restart\s+3v0[.!?\s]*$", re.IGNORECASE),
)
...
class BasePlatformAdapter(ABC):
    ...
    # into the ``EV0_SESSION_ASYNC_DELIVERY`` contextvar at session-bind
    ...
    # 3V0 commands.  Default "/" (most platforms deliver "/approve" etc.
    ...
    def __init__(self, config: PlatformConfig, platform: Platform):
        ...
        # Cross-EV0_HOME token takeover is armed by GatewayRunner only for
        ...
        self._busy_text_debounce_seconds: float = _float_env(
            "EV0_GATEWAY_BUSY_TEXT_DEBOUNCE_SECONDS", 0.35
        )
        self._busy_text_hard_cap_seconds: float = _float_env(
            "EV0_GATEWAY_BUSY_TEXT_HARD_CAP_SECONDS", 1.0
        )
    ...
    def prefers_fresh_final_streaming(
        ...
        implementation supports. Telegram is the motivating case: 3V0 sends
    ...
    def _acquire_platform_lock(self, scope: str, identity: str, resource_desc: str) -> bool:
        ...
        A live cross-EV0_HOME holder may be replaced only when the runner
    ...
    async def send_voice(
        ...
        **kwargs,
        ...
        host filesystem path that would leak the 3V0 home layout.
        """
    ...
    async def send_video(
        ...
        **kwargs,
        ...
        would leak the 3V0 home layout.
        """
    ...
    def _mask_json_string_media(content: str) -> str:
        ...
        Serialized tool results frequently embed a previous reply's text, e.g.::
            ...
            {"result": "MEDIA:/Users/x/.3V0/media/generated/stale.png"}
    ...
    def _get_human_delay() -> float:
        ...
        Reads from env vars:
          EV0_HUMAN_DELAY_MODE: "off" (default) | "natural" | "custom"
    ...
    async def _process_message_background(self, event: MessageEvent, session_key: str) -> None:
        ...
        try:
                ...
                if (self._should_auto_tts_for_chat(event.source.chat_id)
                    ...
                    try:
                        ...
                        if check_tts_requirements():
                            ...
                            # EV0_SESSION_PLATFORM contextvar the tool would
            ...
            # not at the top of this task.  _ev0_run_generation is set on
    ...
    def build_source(
        ...
        per-profile EV0_HOME isolation.
        """

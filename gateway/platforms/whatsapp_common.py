...
class WhatsAppBehaviorMixin:
    ...
    DEFAULT_REPLY_PREFIX: str = "⚕ *3V0 Agent*\n────────────\n"
...
def resolve_whatsapp_bridge_dir() -> Path:
    """Resolve the WhatsApp bridge directory, mirroring to EV0_HOME if needed.

    When the install tree is read-only (e.g., Docker /opt/3v0), this function
    mirrors the bridge source to a writable EV0_HOME location and returns that

...
DIRECTORY_PATH = get_ev0_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_ev0_home() / "channel_aliases.json"
...
def _build_from_sessions_json(platform_name: str) -> List[Dict[str, str]]:
    ...
    sessions_path = get_ev0_home() / "sessions" / "sessions.json"

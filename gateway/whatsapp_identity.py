...
def expand_whatsapp_aliases(identifier: str) -> Set[str]:
    ...
    bridge's ``$EV0_HOME/whatsapp/session/lid-mapping-*.json`` files,
    ...
    session_dir = get_threev0_dir("platforms/whatsapp/session", "whatsapp/session")

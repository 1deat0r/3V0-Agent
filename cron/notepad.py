...
Write path is the CLI (``3v0 cron notepad <job_id> set <key> <value>``),
...
def render_notepad_section(job_id: str) -> str:
    ...
    return (
        ...
        f"`3v0 cron notepad {job_id} set <key> <value>` "
        f"(also: get/delete/list; `3v0 cron notepad {job_id} delete "

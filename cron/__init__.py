"""
Cron job scheduling system for 3V0 Agent.
...
Cron jobs are executed automatically by the gateway daemon:
    3v0 gateway install    # Install as a user service
    sudo 3v0 gateway install --system  # Linux servers: boot-time system service
    3v0 gateway            # Or run in foreground

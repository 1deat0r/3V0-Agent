#!/usr/bin/env python3
"""
SWE Runner with 3V0 Trajectory Format

A runner that uses 3V0-Agent's built-in execution environments
...
# ============================================================================
# Terminal Tool Definition (matches 3V0-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using 3V0-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with 3V0 Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses 3V0-Agent's built-in execution environments
    and outputs trajectories in 3V0-Agent format.
    """
    ...
    def _convert_to_threev0_format(
        ...
        """
        Convert internal message format to 3V0 trajectory format.
...
def main(
    ...
    """
    Run SWE tasks with 3V0 trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with 3V0 Trajectory Format")
    print("=" * 60)

...
Wraps the [Stripe Projects](https://projects.dev) CLI plugin so 3V0 can provision SaaS services (Neon, Twilio, Vercel, etc.), generate and sync credentials into the user's `.env`, and manage billing across providers from one place.

...
version: 1.0.0
author: Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), 3V0 Agent
license: MIT
...
Helper script path: `~/.3V0/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.3V0/skills/blockchain/evm/scripts/evm_client.py
...
python ~/.3V0/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python ~/.3V0/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```

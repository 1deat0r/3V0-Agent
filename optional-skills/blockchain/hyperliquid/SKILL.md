...
version: 0.1.0
author: Hugo Sequier (Hugo-SEQUIER), 3V0 Agent
license: MIT
...
The script reads `${EV0_HOME:-~/.3v0}/.env` for two optional defaults:
...
Helper script: `~/.3V0/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python ~/.3V0/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `${EV0_HOME:-~/.3v0}/.env`.
...
```bash
python ~/.3V0/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.3V0/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \

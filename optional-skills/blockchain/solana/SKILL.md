...
version: 0.2.0
author: Deniz Alagoz (gizdusum), enhanced by 3V0 Agent
license: MIT
...
Helper script path: ~/.3V0/skills/blockchain/solana/scripts/solana_client.py
...
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.3V0/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```

...
The design is **3V0-native**: a small deterministic Python CLI (`scripts/pdd.py`) owns the state
...
```bash
3v0 skills install official/security/unbroker
```

Then start a new 3V0 session and drive it (below). The skill works zero-config; a few optional
...
- **PII handling.** Dossiers live under the 3V0 home directory (`0600`, optionally

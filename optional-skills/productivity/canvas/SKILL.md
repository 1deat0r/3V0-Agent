...
4. Name the token (e.g., "3V0 Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `${EV0_HOME:-~/.3v0}/.env`:
...
```bash
CANVAS="python $EV0_HOME/skills/productivity/canvas/scripts/canvas_api.py"

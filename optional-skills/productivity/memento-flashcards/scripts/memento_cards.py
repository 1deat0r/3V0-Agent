...
Data file: $EV0_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_EV0_HOME = Path(os.environ.get("EV0_HOME", Path.home() / ".3V0"))
DATA_DIR = _EV0_HOME / "skills" / "productivity" / "memento-flashcards" / "data"

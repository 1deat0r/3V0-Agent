...
version: 1.0.1
author: Joe Rinaldi Johnson (joerj123), 3V0 Agent
license: MIT
...
| Telegram (3V0 Agent + all other agents) | Do **not** send an image. Send separate messages — never one combined message. |

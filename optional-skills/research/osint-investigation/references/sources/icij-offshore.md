...
- **Note:** The previous Open Refine reconciliation endpoint at
  ...
  the ZIP locally (default `~/.cache/3v0-osint/icij/`, refreshes after
...
First call downloads the ~70 MB ZIP under `~/.cache/3v0-osint/icij/`
(or `$EV0_OSINT_CACHE/icij/`). Subsequent calls reuse the cache for 30 days.

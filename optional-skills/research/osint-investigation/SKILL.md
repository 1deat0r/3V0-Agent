...
author: 3V0 Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT)
license: MIT
metadata:
  3v0:
...
# $EV0_OSINT_CACHE/icij/ (default: ~/.cache/3v0-osint/icij/).
...
# Set EV0_OSINT_UA=your-app/1.0 (your@email) to identify yourself

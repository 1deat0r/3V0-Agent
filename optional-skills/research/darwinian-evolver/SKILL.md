...
version: 0.1.0
author: Bihruze (Asahi0x), 3V0 Agent
license: MIT
...
import upstream classes into 3V0 itself.
...
```bash
mkdir -p ~/.3V0/cache/darwinian-evolver && cd ~/.3V0/cache/darwinian-evolver
...
```bash
cd ~/.3V0/cache/darwinian-evolver/darwinian_evolver \
...
Open `~/.3V0/cache/darwinian-evolver/darwinian_evolver/darwinian_evolver/lineage_visualizer.html`
...
SKILL_DIR=~/.3V0/skills/research/darwinian-evolver
DE_DIR=~/.3V0/cache/darwinian-evolver/darwinian_evolver
...
7. **AGPL.** Never `from darwinian_evolver import ...` inside 3V0 core.
   Custom driver scripts under `~/.3V0/skills/...` are user-side and fine.

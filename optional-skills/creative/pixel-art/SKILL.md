...
import sys
import os
sys.path.insert(0, os.path.expanduser("~/.3V0/skills/creative/pixel-art/scripts"))
...
```bash
cd ~/.3V0/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — 3V0 installs package this)

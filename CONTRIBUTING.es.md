...
├── ev0_state.py           # Base de datos de sesiones SQLite con búsqueda de texto completo FTS5, títulos de sesión
...
│
├── ev0_cli/               # Implementaciones de comandos CLI
...
- **Persistencia de sesión**: Todas las conversaciones se almacenan en SQLite (`ev0_state.py`) con búsqueda de texto completo y títulos de sesión únicos.
...
Añade al dict `_BUILTIN_SKINS` en `ev0_cli/skin_engine.py`. Usa el mismo esquema que arriba pero como dict de Python.

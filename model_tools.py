...
#   - cli.py, ev0_cli/*      -> inline on startup (no event loop)
...
def _resolve_active_context_length() -> int:
    ...
    """
    try:
        from ev0_cli.config import load_config as _load
        cfg = _load() or {}
    ...
    try:
        ...
        try:
            ...
            if skip_tool_execution_middleware:
                ...
                from ev0_cli.middleware import run_tool_execution_middleware

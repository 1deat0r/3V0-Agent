...
Trust levels:
  - builtin:   Ships with 3V0. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.3v0/\.env|\~/\.3v0/\.env',
     "ev0_env_access", "critical", "exfiltration",
     "directly references 3V0 secrets file"),
    ...
    (r'\.3v0/config\.yaml|\.3v0/SOUL\.md',
     "ev0_config_mod", "critical", "persistence",
     "references 3V0 configuration files directly"),
...
# scan. `.skillignore` is the 3V0-native name; `.clawhubignore` is honored

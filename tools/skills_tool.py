...
# Cache validation (mirrors threev0_cli/profiles.py::_count_skills, d5eee133e):
...
def load_env() -> Dict[str, str]:
    ...
    # the canonical readers in threev0_cli/config.py).
...
def _serve_plugin_skill(
    ...
    *,
    ...
    from threev0_cli.plugins import _get_disabled_plugins, get_plugin_manager

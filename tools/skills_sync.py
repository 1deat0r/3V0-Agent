...
for _stream in (sys.stdout, sys.stderr):
    if hasattr(_stream, "reconfigure"):
        try:
            ...
            pass
from ev0_constants import get_bundled_skills_dir, get_ev0_home, get_optional_skills_dir
...
# ev0_cli.profiles.NO_BUNDLED_SKILLS_MARKER (kept as a literal here to

...
class UIElement:
    ...
    # (trycua/cua#1961 — Surface 6 of 1deat0r/3V0-Agent#47072).
...
class CaptureResult:
    ...
    # trycua/cua#1961 — Surface 7 of 1deat0r/3V0-Agent#47072).
...
class ActionResult:
    ...
    verify → escalate ladder (1deat0r/3V0-Agent#67052). ``ok`` stays

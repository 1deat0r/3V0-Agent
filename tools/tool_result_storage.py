...
2. **Per-result persistence** (maybe_persist_tool_result): After a tool
   ...
   SANDBOX temp dir (for example /tmp/3v0-results/{tool_use_id}.txt on
   standard Linux, or $TMPDIR/3v0-results/{tool_use_id}.txt on Termux)
...
STORAGE_DIR = "/tmp/3v0-results"
HEREDOC_MARKER = "EV0_PERSIST_EOF"
...
def _heredoc_marker(content: str) -> str:
    ...
    return f"EV0_PERSIST_{uuid.uuid4().hex[:8]}"

...
_FORCE_SYNC_ENV = "EV0_FORCE_FILE_SYNC"
...
def iter_sync_files(container_base: str = "/root/.3V0") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.3V0 to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``EV0_FORCE_FILE_SYNC=1`` is set.
    ...
    def _sync_back_transaction(self, threev0_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .3V0/ directory.
    ...
    def _sync_back_impl(self) -> None:
        ...
        with tempfile.NamedTemporaryFile(suffix=".tar") as tf:
            ...
            with tempfile.TemporaryDirectory(prefix="3v0-sync-back-") as staging:
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.3V0/skills/a.md`` →
        ``~/.3V0/skills/a.md``, a new remote file at
        ``/root/.3V0/skills/b.md`` maps to ``~/.3V0/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []

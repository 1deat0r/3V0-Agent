#!/usr/bin/env python3
"""Read the in-app browser / preview pane in the 3V0 desktop GUI.
...
def read_preview_tool(
    ...
    if callback is None:
        return tool_error("read_preview is only available in the 3V0 desktop app.")
...
READ_PREVIEW_SCHEMA = {
    ...
    "description": (
        ...
        "3V0 desktop GUI (the pane open_preview opens beside this chat). Call "

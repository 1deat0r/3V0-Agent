...
from ev0_cli.config import DEFAULT_CONFIG, cfg_get
...
# comparison sites (four here, plus ev0_cli/tools_config.py and
# ev0_cli/doctor.py) from drifting if the sentinel's exact spelling ever
# changes.

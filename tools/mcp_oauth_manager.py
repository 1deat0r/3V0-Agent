...
`mcp_tool.py`, and `threev0_cli/mcp_config.py`. This module is the ONLY place
...
# ---------------------------------------------------------------------------
# Ev0MCPOAuthProvider — OAuthClientProvider subclass with disk-watch
# ---------------------------------------------------------------------------
...
def _make_ev0_provider_class() -> Optional[type]:
    ...
    class Ev0MCPOAuthProvider(OAuthClientProvider):
        ...
        async def _initialize(self) -> None:
            ...
            Paired with :class:`Ev0TokenStorage` persisting an absolute
            ...
            if (
                isinstance(storage, Ev0TokenStorage)
            ...
            async with httpx.AsyncClient(timeout=10.0) as client:
                ...
                for url in build_oauth_authorization_server_metadata_discovery_urls(
                    ...
                    if asm:
                        ...
                        storage = self.context.storage
                        from tools.mcp_oauth import Ev0TokenStorage
                        if isinstance(storage, Ev0TokenStorage):
        ...
        def _persist_oauth_metadata_if_changed(self) -> None:
            ...
            storage = self.context.storage
            from tools.mcp_oauth import Ev0TokenStorage
            if not isinstance(storage, Ev0TokenStorage):
                return
        ...
        async def _maybe_flag_poisoned_client(self, response: Any) -> None:
            ...
            and is handled by ``3v0 mcp reauth``.
...
class MCPOAuthManager:
    ...
    def _build_provider(
        ...
        Constructs :class:`Ev0MCPOAuthProvider` directly using the helpers
        ...
        if (
            ...
            raise OAuthNonInteractiveError(
                ...
                "cached tokens found. Run `3v0 mcp login "
    ...
    def remove(
        ...
        *,
        ...
        Called by ``3v0 mcp remove <name>`` and (indirectly) by

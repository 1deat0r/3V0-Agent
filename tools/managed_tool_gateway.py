...
def auth_json_path():
    """Return the 3V0 auth store path, respecting EV0_HOME overrides."""
    return get_threev0_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`3v0 tools`, banner/status paint, provider
...
# managed vendor's gateway URL is pinned: adding one is a 3V0 release, and

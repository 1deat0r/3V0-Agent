...
| `website/scripts/prebuild.mjs` | js-module | JS module `prebuild.mjs` | Node/Electron JS source executed by the build/runtime; check git intent before deleting | website/scripts/extract-automation-blueprints.py; website/scripts/extract-skills.py; website/scripts/generate-llms-txt.py; website/scripts/generate-skill-docs.py |

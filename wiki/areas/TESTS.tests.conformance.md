# tests/ + tests-js/ + evals/ — the test suites — `tests/conformance/`
...
|------|------|---------|-----|---------|
| `tests/conformance/__init__.py` | test | Python module `__init__.py` | Test module — asserts the repo contract; run via scripts/run_tests.sh | tests/conformance/test_vector_generator.py; tests/conformance/vectors/discord.json; tests/conformance/vectors/slack.json; tests/conformance/vectors/telegram.json |

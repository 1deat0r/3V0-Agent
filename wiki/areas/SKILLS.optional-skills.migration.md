...
|------|------|---------|-----|---------|
| `optional-skills/migration/DESCRIPTION.md` | doc | Optional migration workflows for importing user state and customizations from | Human/agent-readable documentation; the wiki keeps it pointer-capped | optional-skills/migration/openclaw-migration/SKILL.md; optional-skills/migration/openclaw-migration/scripts/openclaw_to_hermes.py |

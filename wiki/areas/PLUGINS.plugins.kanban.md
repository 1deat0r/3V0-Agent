...
|------|------|---------|-----|---------|
| `plugins/kanban/dashboard/dist/index.js` | asset | File `index.js` | Repository content; see related files / area page for the enclosing subsystem | plugins/kanban/dashboard/dist/style.css |

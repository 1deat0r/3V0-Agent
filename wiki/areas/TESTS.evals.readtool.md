...
| `evals/readtool/results/.gitignore` | asset | File `.gitignore` | Repository content; see related files / area page for the enclosing subsystem | evals/readtool/results/SUMMARY.md |
| `evals/readtool/results/SUMMARY.md` | doc | Documentation page | Human/agent-readable explanation; knowledge layer | evals/readtool/results/.gitignore |

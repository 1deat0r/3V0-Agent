...
| `plugins/hermes-achievements/dashboard/dist/index.js` | js-module | JS module `index.js` | Node/Electron JS source executed by the build/runtime; check git intent before deleting | plugins/hermes-achievements/dashboard/dist/style.css |
...
| `plugins/hermes-achievements/tests/test_achievement_engine.py` | test | Tests `plugins/hermes-achievements/tests/test_achievement_engine.py` — see related for the module under test | Test module — asserts the repo contract; run via scripts/run_tests.sh | plugins/hermes-achievements/tests/ |

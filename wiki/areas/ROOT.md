...
| `cli.py` | source | Ev0CLI — interactive CLI orchestrator (prompt_toolkit + Rich), slash commands, session management | The primary human-facing surface; hosts command dispatch and config loading | ev0_cli/config.py; ev0_cli/main.py; run_agent.py |

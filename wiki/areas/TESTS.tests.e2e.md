# tests/ + tests-js/ + evals/ — the test suites — `tests/e2e/`
...
|------|------|---------|-----|---------|
| `tests/e2e/__init__.py` | test | Python module `__init__.py` | Test module — asserts the repo contract; run via scripts/run_tests.sh | tests/e2e/conftest.py; tests/e2e/matrix_xsign_bootstrap/README.md; tests/e2e/matrix_xsign_bootstrap/docker-compose.yml; tests/e2e/matrix_xsign_bootstrap/test_bootstrap.py |
...
| `tests/e2e/matrix_xsign_bootstrap/docker-compose.yml` | config | YAML configuration | Declarative config for deployment/CI/tooling | tests/e2e/matrix_xsign_bootstrap/README.md; tests/e2e/matrix_xsign_bootstrap/test_bootstrap.py |

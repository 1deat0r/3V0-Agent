...
|------|------|---------|-----|---------|
| `tests/website/__init__.py` | test | Tests `website/__init__.py` — see related for the module under test | Test module — asserts the repo contract; run via scripts/run_tests.sh | tests/website/test_extract_skills.py; tests/website/test_generate_skill_docs.py |

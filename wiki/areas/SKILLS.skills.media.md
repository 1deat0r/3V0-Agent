...
|------|------|---------|-----|---------|
| `skills/media/DESCRIPTION.md` | doc | Documentation page | Human/agent-readable explanation; knowledge layer | skills/media/gif-search/SKILL.md; skills/media/songsee/SKILL.md; skills/media/youtube-content/SKILL.md; skills/media/youtube-content/references/output-formats.md |
...
| `skills/media/youtube-content/references/output-formats.md` | doc | Documentation page | Human/agent-readable explanation; knowledge layer | skills/media/youtube-content/references/ |

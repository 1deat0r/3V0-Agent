...
late-binding seam in :mod:`threev0_cli.web_deps` so tests that
...
async def update_profile_soul(name: str, body: ProfileSoulUpdate):
    ...
    try:
        ...
        # profiles seed SOUL.md at the umask default (threev0_cli.profiles
...
async def describe_profile_auto_endpoint(name: str, body: ProfileDescribeAuto):
    ...
    try:
        from threev0_cli import profile_describer
...
# ── Export / Import ──────────────────────────────────────────────────────────
# Profile sharing for the desktop: wraps threev0_cli.profiles.export_profile /

"""Client for uploading ``3v0 debug share`` bundles to Nous-internal S3.

This is the opt-in (``--nous``) destination for ``3v0 debug share``.
...
_USER_AGENT = "3v0-agent/debug-share"

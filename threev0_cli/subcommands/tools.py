...
def build_tools_parser(subparsers, *, cmd_tools: Callable) -> None:
    ...
    tools_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Run '3v0 tools' with no subcommand for the interactive configuration UI."
        ),
    )
    ...
    # 3v0 tools disable <name...> [--platform cli]
    ...
    # 3v0 tools enable <name...> [--platform cli]
    ...
    tools_postsetup_p = tools_sub.add_parser(
        ...
        description=(
            ...
            "same step `3v0 tools` runs after you pick a provider that\n"

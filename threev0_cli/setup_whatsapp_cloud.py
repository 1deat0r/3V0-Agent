...
Entry point: ``3v0 whatsapp-cloud`` (dispatched from
``cmd_whatsapp_cloud`` in ``threev0_cli/main.py``).
...
3V0 gateway and the cloudflared tunnel both run in separate
...
def run_whatsapp_cloud_setup() -> int:
    ...
    print("=" * 50)
    print()
    print("This wizard configures 3V0 to talk to WhatsApp via Meta's")
    ...
    print("─" * 50)
    print()
    print("  3V0 needs a public HTTPS URL to receive WhatsApp messages.")
    ...
    print()
    print("    3. Start the 3V0 gateway in another terminal:")
    print("         3v0 gateway")
    print()
    ...
    print()
    print("  Docs: https://github.com/1deat0r/3V0-Agent/docs/user-guide/")

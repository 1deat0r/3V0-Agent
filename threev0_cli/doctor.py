...
from threev0_constants import is_termux as _is_termux
...
def _has_healthy_oauth_fallback_for_apikey_provider(provider_label: str) -> bool:
    ...
    if normalized == "minimax":
        try:
            from threev0_cli.auth import get_minimax_oauth_auth_status
...
from threev0_cli.sizefmt import format_bytes as _human_bytes
...
def _check_version_consistency(issues: list[str]) -> None:
    """Verify pyproject.toml version matches threev0_cli.__version__.
    ...
    """
    try:
        from threev0_cli import __version__ as init_version
    except Exception:
        return
    ...
    if pyproject_version == init_version:
        ...
        _fail_and_issue(
            ...
            f"(pyproject.toml {pyproject_version} != threev0_cli/__init__.py {init_version})",
            "Re-sync version files (e.g. run '3v0 update', or set "
            "threev0_cli/__init__.py __version__ to match pyproject.toml)",
            issues,
        )
...
def _build_apikey_providers_list() -> list:
    ...
    try:
        ...
        try:
            from threev0_cli.providers import normalize_provider as _normalize_provider
...
def run_doctor(args):
    ...
    try:
        import sqlite3
        from threev0_state import is_sqlite_wal_reset_vulnerable, sqlite_source_id
    ...
    # Detect drift between pyproject.toml and threev0_cli/__init__.py versions
    ...
    if env_path.exists():
        ...
        # matches threev0_cli.env_loader._load_dotenv_with_fallback.
        try:
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from threev0_cli.config import get_compatible_custom_providers as _compatible_custom_providers
            ...
            if isinstance(user_providers, dict):
                from threev0_cli.config import is_provider_enabled
            ...
            if runtime_provider and runtime_provider not in ("auto", "custom"):
                try:
                    if runtime_provider == "openrouter":
                        ...
                        from threev0_cli.auth import PROVIDER_REGISTRY, get_auth_status
        ...
        if fallback_config.exists():
            ...
            if should_fix:
                ...
                if example_config.exists():
                    ...
                    from threev0_cli.config import DEFAULT_CONFIG, save_config
    ...
    if config_path.exists():
        ...
        try:
            from threev0_cli.config import load_env, read_user_config_raw, remove_env_value
        ...
        try:
            from threev0_cli.config import load_env as _load_env_depr
            from threev0_cli.config import read_user_config_raw as _read_raw_depr
    ...
    if state_db_path.exists():
        try:
            ...
            from threev0_state import _db_opens_cleanly, repair_state_db_schema
            ...
            from threev0_state import is_malformed_db_error, repair_state_db_schema
        ...
        try:
            from threev0_state import collect_state_db_stats, count_db_holders
    ...
    try:
        from threev0_cli.config import read_user_config_raw as _read_raw_mem
    ...
    try:
        from threev0_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
    ...
    try:
        from threev0_cli.doctor_live import maybe_run_live_checks

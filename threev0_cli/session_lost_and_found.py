...
``3v0 sessions recover --allow-partial`` normally copies rows through SQL,
...
rows back into a fresh current-schema 3V0 session database.
...
# 3V0 session ids are timestamps: 20260812_135332_ab12cd. This is the
...
def _cli_supports_recover(binary: str) -> bool:
    ...
    scratch_dir = tempfile.mkdtemp(prefix="3v0-recover-probe-")

"""Relay subscriber for the persisted 3V0 shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated 3V0 counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the 3V0 shared metric: %s",
                    metric_name,
                    exc_info=True,
                )

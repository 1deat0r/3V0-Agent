"""3V0 skin/theme engine — the theme SDK for every surface.

A data-driven skin system that lets users (and 3V0 itself) customize the
visual appearance across the CLI, the TUI, and the desktop GUI from a single
file. Skins are defined as YAML files in ~/.3V0/skins/ or as built-in presets.
...
``resolve_skin`` / ``skin.changed``). A skin dropped in ~/.3V0/skins/ therefore
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "3V0 Agent"          # Banner title, status display
      welcome: "Welcome message"          # Shown at CLI startup
      goodbye: "Goodbye! ⚕"              # Shown on exit
      response_label: " ⚕ 3V0 "       # Response box header label
...
.. code-block:: python
    ...
    from threev0_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "3V0 Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.3V0/skins/
...
Drop a YAML file in ``~/.3V0/skins/<name>.yaml`` following the schema above.
...
class SkinConfig:
    ...
    banner_logo: str = ""    # Rich-markup ASCII art logo (replaces EV0_AGENT_LOGO)
    banner_hero: str = ""    # Rich-markup hero art (replaces EV0_CADUCEUS)
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic 3V0 — gold and kawaii",
        # Dark-authored. Values match the TUI's DARK_THEME so the classic CLI
        # and the TUI render the same 3V0 gold.
        "colors": {
            # Tide — the restrained 3V0 identity (single sky accent, neutral
            # cool canvas, semantic trio). Mirrors ui-tui/src/theme.ts.
            "banner_border": "#3c424c",
            "banner_title": "#7DD3E8",
            "banner_accent": "#7DD3E8",
            "banner_dim": "#8A93A3",
            "banner_text": "#E6E9EF",
            "ui_accent": "#7DD3E8",
            "ui_label": "#9AA3B0",
            ...
            "prompt": "#E6E9EF",
            "input_rule": "#3c424c",
            "response_border": "#3c424c",
            "status_bar_bg": "#141922",
            "status_bar_text": "#C6CBD4",
            "status_bar_strong": "#7DD3E8",
            "status_bar_dim": "#8A93A3",
            "status_bar_good": "#7ACB8E",
            "status_bar_warn": "#E0A458",
            "status_bar_bad": "#E06570",
            "status_bar_critical": "#E06570",
            "session_label": "#9AA3B0",
            "session_border": "#62666B",
            "completion_menu_bg": "#141922",
            "completion_menu_current_bg": "#22303C",
            "selection_bg": "#22303C",
            "shell_dollar": "#7DD3E8",
            "voice_status_bg": "#141922",
        },
        ...
        "light_colors": {
            ...
            "ui_warn": "#9A6A1F",
            "prompt": "#20262E",
            "response_border": "#D5DBE3",
            "session_label": "#4A5460",
            "status_bar_text": "#3E4650",
            "status_bar_strong": "#0E7490",
            "status_bar_dim": "#6E7887",
            "status_bar_good": "#2E8B57",
            "status_bar_warn": "#9A6A1F",
            "status_bar_bad": "#C24A55",

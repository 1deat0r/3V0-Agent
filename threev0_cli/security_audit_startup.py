...
3. Running inside a container with no persistent volume mount over the
   EV0_HOME data dir (state is ephemeral — lost on container restart).
...
logger = logging.getLogger("3v0.security_audit")
...
def _running_as_root() -> Optional[str]:
    ...
    return (
        ...
        "full host compromise. Run 3V0 as an unprivileged user (or in a "

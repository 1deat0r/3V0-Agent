...
_PROFILE_DIRS = [
    ...
    # See threev0_constants.get_subprocess_home().
    "home",
]
...
# (#58394). Add new artifacts here when introduced in ``threev0_constants``.
...
def create_profile(
    ...
    if not soul_path.exists():
        try:
            from threev0_cli.default_soul import DEFAULT_SOUL_MD
...
def _maybe_register_gateway_service(profile_name: str) -> None:
    ...
    try:
        ...
        from threev0_cli.service_manager import get_service_manager

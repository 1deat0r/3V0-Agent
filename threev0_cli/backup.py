...
from threev0_cli.sizefmt import format_bytes as _format_size
...
def verify_sqlite_integrity(
    ...
    *,
    ...
    if check_header:
        ...
        # threev0_cli.sqlite_safe_read). Verification targets snapshots and
    ...
    with zipfile.ZipFile(zip_path, "r") as zf:
        ...
        if profiles_dir.is_dir():
            try:
                ...
                # threev0_cli.profiles might not be available (fresh install)
        ...
        try:
            from threev0_cli.gateway import ensure_gateway_service, _is_service_running

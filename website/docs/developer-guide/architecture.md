...
│ ev0_state.py   │              │ Browser (5 backends)  │
...
├── ev0_state.py           # SQLite session/state database with FTS5
├── ev0_constants.py       # HERMES_HOME, profile-aware paths
...
│
├── ev0_cli/               # CLI subcommands and setup

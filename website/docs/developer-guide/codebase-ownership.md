...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `ev0_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `ev0_cli/` | [Extending the CLI](extending-the-cli.md) |
...
| Session storage | `ev0_state.py` | [Session Storage](session-storage.md) |

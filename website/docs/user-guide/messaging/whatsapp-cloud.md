...
If the model emits tool-call-shaped text instead of a structured call, it usually means the toolset was effectively empty.  See `ev0_cli/platforms.py` for the platform → default toolset mapping.

...
wake_word:
  ...
  openwakeword:
    model: hey_3v0         # bundled default; OR a built-in name OR a path to a custom .onnx/.tflite
...
(`model: hey_3v0`) is the default. To wake on something else, the easiest
...
wake_word:
  ...
  phrase: "hey hermes"
  porcupine:
    keyword: ~/.hermes/wakewords/hey_3v0.ppn
```

...
```
/goal Fix every failing test in tests/ev0_cli/ and make sure scripts/run_tests.sh passes for that directory
```
...
/goal gate add scripts/run_tests.sh tests/ev0_cli/test_goals.py
```

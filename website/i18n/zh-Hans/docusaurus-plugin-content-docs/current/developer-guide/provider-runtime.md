...
- `ev0_cli/runtime_provider.py` — 凭据解析，`_resolve_custom_runtime()`
- `ev0_cli/auth.py` — provider 注册表，`resolve_provider()`
- `ev0_cli/model_switch.py` — 共享 `/model` 切换流水线（CLI + gateway）

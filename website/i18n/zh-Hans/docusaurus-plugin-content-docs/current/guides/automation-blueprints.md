...
3. For each merged PR, check if it modified:
   ...
   - CLI commands (ev0_cli/commands.py, ev0_cli/main.py) — may need docs/reference/cli-commands.md update
   - Config options (ev0_cli/config.py) — may need docs/user-guide/configuration.md update

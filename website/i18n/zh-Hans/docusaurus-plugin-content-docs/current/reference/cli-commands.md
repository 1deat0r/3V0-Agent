...
完整设计——与 Cline Kanban / Paperclip / NanoClaw / Gemini Enterprise 的对比、八种协作模式、四个用户故事、并发正确性证明——请参阅仓库中的 `docs/3v0-kanban-v1-spec.pdf` 或 [Kanban 用户指南](/user-guide/features/kanban)。

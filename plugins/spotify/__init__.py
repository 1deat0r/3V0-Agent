...
``_check_spotify_available()`` — when the user has not run ``3v0 auth
spotify``, the tools remain registered (so they appear in ``3v0
...
The Spotify auth flow (``3v0 auth spotify``), CLI plumbing, and docs

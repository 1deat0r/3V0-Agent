...
Configuration
-------------
Secret (lives in $EV0_HOME/.env or the environment):
...
Behavioral settings (live in $EV0_HOME/mem0.json, set via `3v0 memory
setup`):
  ...
  agent_id           — Agent identifier (default: 3v0)
...
def _load_config() -> dict:
    """Load config from env vars, with $EV0_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "3v0"),
        "oss": {},
    }
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $EV0_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "3v0")

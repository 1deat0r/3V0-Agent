...
```bash
3v0 memory setup    # select "byterover"
```

Or manually:
```bash
3v0 config set memory.provider byterover
# Optional cloud sync:
echo "BRV_API_KEY=your-key" >> ~/.3V0/.env
```
...
Working directory: `$EV0_HOME/byterover/` (profile-scoped).

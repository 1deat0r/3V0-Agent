...
Single-user 3V0 memory store plugin.
"""
...
class MemoryStore:
    ...
    def _init_db(self) -> None:
        ...
        # gracefully on NFS/SMB/FUSE-mounted EV0_HOME (same issue as
        # state.db / kanban.db — see threev0_state._WAL_INCOMPAT_MARKERS).

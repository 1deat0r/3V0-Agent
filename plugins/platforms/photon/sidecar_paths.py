...
under an immutable ``/opt/3v0`` (read-only for the 3v0 user), which
...
4. Source dir read-only and deps missing or stale → mirror the sidecar
   source files to ``$EV0_HOME/photon/sidecar`` (the durable data volume,

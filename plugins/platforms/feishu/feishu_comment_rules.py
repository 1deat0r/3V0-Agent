...
Config: ~/.3V0/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.3V0/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_ev0_home()`` helper (EV0_HOME-aware and

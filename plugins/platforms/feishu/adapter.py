...
class FeishuAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._dedup_state_path = get_ev0_home() / "feishu_seen_message_ids.json"
    ...
    def _write_update_prompt_response(answer: str) -> None:
        response_path = get_ev0_home() / ".update_response"
    ...
    def _on_card_action_trigger(self, data: Any) -> Any:
        ...
        ev0_action = action_value.get("ev0_action") if isinstance(action_value, dict) else None
    ...
    async def _connect_websocket(self) -> None:
        ...
        self._ws_client = FeishuWSClient(
            ...
            # See https://github.com/NousResearch/3v0-agent/issues/50656

...
required — uses aiohttp which is already a 3V0 dependency.
...
def interactive_setup() -> None:
    ...
    ``threev0_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where 3V0 delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # threev0_cli/setup.py::_setup_mattermost function.

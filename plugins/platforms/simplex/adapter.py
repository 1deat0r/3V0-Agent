"""SimpleX Chat platform adapter (3V0 plugin).
...
``plugins/platforms/simplex/``. The 3V0 plugin loader scans the
...
discoverable and ``3v0 setup`` can describe it even when websockets is
...
# Imported at module top because they're stdlib-only inside 3V0 — no
...
def interactive_setup() -> None:
    """Minimal stdin wizard for ``3v0 setup gateway`` → SimpleX.

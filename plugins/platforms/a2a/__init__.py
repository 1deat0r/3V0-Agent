"""
A2A (Agent-to-Agent) plugin for 3V0 Agent.

Registers:
  - The ``a2a`` platform adapter (inbound: exposes 3V0 as an A2A agent,
    protocol v1.0).
...
def interactive_setup() -> None:
    ...
    print_info("Expose 3V0 as an A2A-discoverable agent and call other A2A agents.")

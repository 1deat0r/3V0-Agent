...
# + _PLATFORMS["matrix"] static dict in threev0_cli/{setup,gateway}.py, and the
...
def interactive_setup() -> None:
    """Configure Matrix credentials. Replaces threev0_cli/setup.py::_setup_matrix
...
def _is_connected(config) -> bool:
    ...
    configured. Read via threev0_cli.gateway.get_env_value so setup-status

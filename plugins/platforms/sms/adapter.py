...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> 3V0 gateway adapter.

    Each inbound phone number gets its own 3V0 session (multi-tenant).
...
# static dict in threev0_cli/gateway.py, and the _send_sms dispatch in

...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        # ev0_cli/commands.py automatically appear as Discord slash
        ...
        dropped_over_cap = 0
        try:
            from ev0_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from ev0_cli.commands import _iter_plugin_command_entries
    ...
    def _refresh_skill_catalog_state(self) -> None:
        ...
        """
        from ev0_cli.commands import discord_skill_commands_by_category
...
def _is_connected(config) -> bool:
    ...
    Looks up via ``ev0_cli.gateway.get_env_value`` at call time (not via
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # ev0_cli/setup.py::_setup_discord function.  Same shape as Teams.

...
the contract that subsequent turns echo it back; combined with how 3V0
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; 3V0 remaps
the retired IDs in ``threev0_cli.model_normalize``.
"""
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave 3V0, so they are not listed here.
    """

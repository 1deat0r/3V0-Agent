...
# When the user hasn't picked a reasoning effort, 3V0 passes
...
# ON at this effort — matching the "medium (default)" that 3V0' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map 3V0' effort vocabulary onto Solar's accepted set. xhigh/max/

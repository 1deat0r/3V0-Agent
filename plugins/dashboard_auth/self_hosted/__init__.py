...
:class:`~ev0_cli.dashboard_auth.DashboardAuthProvider` methods and touches
...
``ev0_cli/dashboard_auth/routes.py``; this provider only:
  ...
  4. verifies the **ID token** (RS256/ES256) against the discovered
     ...
     onto a :class:`~ev0_cli.dashboard_auth.Session`.

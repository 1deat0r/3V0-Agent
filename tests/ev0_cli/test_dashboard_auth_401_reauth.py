...
from ev0_cli.dashboard_auth.base import ProviderError, RefreshExpiredError
from ev0_cli.dashboard_auth.cookies import (
    SESSION_AT_COOKIE,
...
class TestTransparentRefreshOnAccessTokenEviction:
    ...
    def _build_rt_only_app(self):
        ...
        """
        import time as _t
        from tests.ev0_cli.conftest_dashboard_auth import _sign
...
class TestAutoSsoRedirect:
    ...
    from ev0_cli.dashboard_auth.cookies import SSO_ATTEMPT_COOKIE
...
class TestNextSameOriginValidation:
    ...
    def test_safe_next_validator_accepts_same_origin(self):
        from ev0_cli.dashboard_auth.middleware import _safe_next_target
...
class TestValidatePostLoginTarget:
    ...
    def test_accepts_same_origin_paths(self):
        from ev0_cli.dashboard_auth.routes import _validate_post_login_target
...
class TestRenderLoginHtmlNext:
    ...
    def test_no_next_emits_plain_button(self):
        from ev0_cli.dashboard_auth.login_page import render_login_html

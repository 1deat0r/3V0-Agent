...
def test_recovered_update_retry_skips_external_secret_sources(tmp_path, monkeypatch):
    ...
    import ev0_cli.env_loader as env_loader
...
def test_latin1_fallback_stream_honors_override(tmp_path, monkeypatch):
    ...
    from ev0_cli.env_loader import _load_dotenv_with_fallback
...
def test_utf32_le_bom_leaves_file_untouched(tmp_path, caplog):
    ...
    from ev0_cli.env_loader import _sanitize_env_file_if_needed
    ...
    with caplog.at_level(logging.WARNING, logger="ev0_cli.env_loader"):
...
def test_cleanup_scope_is_the_profile_managed_set():
    ...
    """
    from ev0_cli.env_loader import _PROFILE_MANAGED_ENV_KEYS
...
# the shared ev0_cli.config.apply_terminal_config_to_env helper.
# ---------------------------------------------------------------------------

...
from ev0_cli import doctor_live
from ev0_cli.doctor_live import (
    ProbeResult,
...
class TestBrowserAvailableNpxRung:
    ...
    def _block_path_and_node_modules_checks(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr("ev0_cli.doctor.EV0_HOME", tmp_path / "home")
        monkeypatch.setattr("ev0_cli.doctor.PROJECT_ROOT", tmp_path / "root")

...
def _request():
    from ev0_cli.approval_transport import ApprovalRequest
...
def test_host_accepts_bound_sync_and_async_decisions():
    from ev0_cli.approval_transport import invoke_approval_transport
...
def test_host_rejects_decision_completed_after_deadline(monkeypatch):
    import ev0_cli.approval_transport as transport_module
...
def test_host_caps_hung_transport_workers():
    from ev0_cli.approval_transport import (

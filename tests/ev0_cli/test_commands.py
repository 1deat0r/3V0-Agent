...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_skips_already_listed(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "ev0_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from ev0_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch ev0_cli.plugins.get_plugin_commands() to a fixed dict."""
        from ev0_cli import plugins as _plugins_mod

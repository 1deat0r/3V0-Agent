"""Tests for ev0_cli.agent_import — ``3v0 import-agent``.
...
Uses the profile_env fixture pattern from tests/ev0_cli/test_profiles.py:
...
from ev0_cli.agent_import import (
    ENTRY_DELIMITER,
    AgentImporter,
...
class TestExistingConfigPreserved:
    ...
    def test_failed_write_does_not_truncate_the_existing_config(
        ...
        from ev0_cli import agent_import

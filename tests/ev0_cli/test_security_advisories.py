"""Tests for ev0_cli.security_advisories.
...
import ev0_cli.security_advisories as adv
...
class TestAck:
    ...
    def test_ack_advisory_persists_id(self, isolated_home, monkeypatch):
        ...
        # don't depend on the full ev0_cli.config bootstrap.
        store: dict = {"security": {}}
        monkeypatch.setattr(
            "ev0_cli.config.load_config", lambda: store
        )
        monkeypatch.setattr(
            "ev0_cli.config.save_config",

...
from ev0_cli.dashboard_auth import clear_providers, register_provider
from ev0_cli.dashboard_auth import prefix as prefix_mod
from tests.ev0_cli.conftest_dashboard_auth import StubAuthProvider
...
class TestPublicUrlOverride:
    ...
    def patch_config(self, monkeypatch):
        """Replace ``ev0_cli.config.load_config`` with a stub
        ...
        def _set(public_url) -> None:
            ...
            monkeypatch.setattr(
                "ev0_cli.config.load_config", lambda: cfg
            )
...
class TestCookiePathRespectsPrefix:
    ...
    def test_loopback_cookies_unprefixed(self):
        ...
        from ev0_cli.dashboard_auth.cookies import set_pkce_cookie

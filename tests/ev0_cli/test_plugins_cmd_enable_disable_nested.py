...
class TestEnableDisableNested:
    @patch("ev0_cli.plugins.get_bundled_plugins_dir")
    @patch("ev0_cli.plugins_cmd._plugins_dir")
    @patch("ev0_cli.plugins_cmd._save_disabled_set")
    @patch("ev0_cli.plugins_cmd._save_enabled_set")
    @patch("ev0_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("ev0_cli.plugins_cmd._get_enabled_set", return_value=set())
    def test_enable_bare_name_writes_key(
        ...
        from ev0_cli.plugins_cmd import cmd_enable
        mock_user.return_value = nested_plugin_env
        mock_bundled.return_value = nested_plugin_env / "nonexistent"
...
class TestEnableToolOverrideConsent:
    ...
    @patch("ev0_cli.plugins.get_bundled_plugins_dir")
    @patch("ev0_cli.plugins_cmd._plugins_dir")
    @patch("ev0_cli.plugins_cmd._set_plugin_entry_flag")
    @patch("ev0_cli.plugins_cmd._save_disabled_set")
    @patch("ev0_cli.plugins_cmd._save_enabled_set")
    @patch("ev0_cli.plugins_cmd._get_disabled_set", return_value=set())
    @patch("ev0_cli.plugins_cmd._get_enabled_set", return_value=set())
...
class TestCompositeMenuWritesCanonicalKey:
    ...
    def test_fallback_unchecked_plugin_disables_by_key_not_name(
        ...
        from ev0_cli.plugins_cmd import _run_composite_fallback

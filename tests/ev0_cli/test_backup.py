...
def _advance_backup_clock(seconds: float = 1.1) -> None:
    """Skew ev0_cli.backup's datetime forward instead of sleeping.
    ...
    import ev0_cli.backup as _backup
...
def _make_ev0_tree(root: Path) -> None:
    ...
    for db_name in ("memory_store.db", "ev0_state.db"):
...
class TestShouldExclude:
    def test_excludes_ev0_agent(self):
        from ev0_cli.backup import _should_exclude
...
class TestBackup:
    ...
    def test_db_snapshots_staged_beside_output_zip(self, tmp_path, monkeypatch):
        ...
        import ev0_cli.backup as backup_mod
        staged_dirs = []
...
class TestValidateBackupZip:
    ...
    def test_state_db_passes(self, tmp_path):
        ...
        from ev0_cli.backup import _validate_backup_zip
...
class TestRoundTrip:
    def test_backup_then_import(self, tmp_path, monkeypatch):
        ...
        from ev0_cli.backup import run_backup, run_import
...
class TestFormatSize:
    def test_bytes(self):
        from ev0_cli.backup import _format_size
...
class TestValidation:
    ...
    def test_detect_prefix_only_dirs(self):
        ...
        import io
        from ev0_cli.backup import _detect_prefix
...
class TestImportAtomicWrites:
    ...
    def test_restore_preserves_existing_file_owner(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "ev0_cli.backup._preserve_file_owner",
...
class TestSafeCopyDb:
    def test_copies_valid_database(self, tmp_path):
        from ev0_cli.backup import _safe_copy_db
    ...
    def test_aborts_when_source_remains_busy_past_deadline(
        ...
        from ev0_cli import backup as backup_mod
    ...
    def test_is_zeroed_sqlite_file_detects_nul_header(self, tmp_path):
        from ev0_cli.backup import is_zeroed_sqlite_file
        p = tmp_path / "state.db"
...
class TestQuickSnapshot:
    ...
    def test_state_db_safely_copied(self, ev0_home):
        from ev0_cli.backup import create_quick_snapshot
...
# ---------------------------------------------------------------------------
    ...
    def test_oversized_db_suppresses_pruning(self, ev0_home, capsys):
        ...
        """
        import json
        from ev0_cli.backup import create_quick_snapshot, list_quick_snapshots
...
class TestQuickSnapshotProjectsKanban:
    ...
    def test_non_default_kanban_board_snapshotted(self, ev0_home):
        ...
        from ev0_cli.backup import create_quick_snapshot, restore_quick_snapshot
...
class TestPreUpdateBackup:
    ...
    def test_backup_contents_match_full_backup(self, ev0_home):
        ...
        from ev0_cli.backup import create_pre_update_backup
...
class TestRunPreUpdateBackup:
    ...
    def test_config_off_disables_everything_silently(self, ev0_home, capsys):
        ...
        from ev0_cli.main import _run_pre_update_backup
...
class TestPreMigrationBackup:
    ...
    def test_restorable_with_ev0_import(self, ev0_home, tmp_path):
        ...
        from ev0_cli.backup import create_pre_migration_backup, _validate_backup_zip
    ...
    def test_does_not_touch_pre_update_backups(self, ev0_home):
        ...
        from ev0_cli.backup import create_pre_update_backup, create_pre_migration_backup
...
class TestRestoreCronJobsIfEmptied:
    ...
    def test_restores_when_emptied_after_migration(self, tmp_path):
        from ev0_cli.backup import restore_cron_jobs_if_emptied
        ev0_home = tmp_path / ".3V0"

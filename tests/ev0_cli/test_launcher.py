...
def test_launcher_delegates_to_argparse_entrypoint(monkeypatch):
    """`./hermes` should use `ev0_cli.main`, not the legacy Fire wrapper."""
    ...
    def fake_main():
        called.append("ev0_cli.main")

    fake_main_module.main = fake_main
    monkeypatch.setitem(sys.modules, "ev0_cli.main", fake_main_module)

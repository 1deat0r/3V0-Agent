...
#
# _load_auth_store lives in ev0_cli/auth.py, but several other modules read
...
class TestAuthJsonSiblingReaders:
    ...
    def test_read_shared_nous_state_reads_non_ascii_store(
        ...
        """ev0_cli.auth._read_shared_nous_state must read a non-ASCII store.
    ...
    def test_has_any_provider_configured_reads_non_ascii_auth_store(
        ...
        """ev0_cli.main._has_any_provider_configured reads auth.json.
        ...
        # ev0_cli.auth; patch it on the source module so the local import
        # sees the fake.

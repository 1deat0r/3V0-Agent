...
code paths in ``ev0_cli/main.py`` that print this notice (the git-pull path
...
import ev0_cli.update_cmd as update_mod
...
def _source_lines() -> list[str]:
    # The update pipeline was extracted to ev0_cli/update_cmd.py

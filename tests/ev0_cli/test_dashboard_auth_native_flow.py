...
Run: pytest tests/ev0_cli/test_dashboard_auth_native_flow.py
"""
...
from ev0_cli.dashboard_auth.base import Session
...
@pytest.fixture
def pw_gated_client():
    from ev0_cli.dashboard_auth.routes import _reset_password_rate_limit
    from tests.ev0_cli.test_dashboard_auth_password_login import (
        PasswordProvider,
    )

...
class TestCustomProviderModelSwitch:
    ...
    def test_custom_endpoint_switch_prunes_stale_model_config_pool_entry(
        ...
        from ev0_cli.main import _model_flow_custom
        ...
        with patch(
            ...
            return_value={
             ...
             patch("ev0_cli.secret_prompt.masked_secret_prompt", return_value="sk-new"), \
             patch("ev0_cli.main._prompt_custom_api_mode_selection", return_value=""), \
             patch(
                 "builtins.input",
                 side_effect=[
    ...
    def test_env_template_api_key_is_preserved_in_model_config(self, config_home, monkeypatch):
        ...
        import yaml
        from ev0_cli.main import _model_flow_named_custom
        ...
        with patch("ev0_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]) as mock_fetch, \
             patch("ev0_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_key_env_custom_provider_persists_reference_not_secret(self, config_home, monkeypatch):
        ...
        with patch("ev0_cli.models.fetch_api_models", return_value=["qwen3.6-35b-fast"]), \
             patch("ev0_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="1"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)
    ...
    def test_env_ref_base_url_preserves_api_key_ref_through_picker(
        ...
        with patch("ev0_cli.main._prompt_provider_choice",
                   side_effect=_pick_neuralwatt), \
             patch("ev0_cli.models.fetch_api_models",
    ...
    def test_picker_recognizes_current_provider_alias_when_name_differs(
        ...
        with patch(
            "ev0_cli.main._prompt_provider_choice",
...
class TestCustomProviderDiscoverModels:
    ...
    def test_discover_false_saves_choice_from_configured_list(self, config_home):
        ...
        with patch("ev0_cli.models.fetch_api_models") as mock_fetch, \
             patch("ev0_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
    ...
    def test_probe_empty_falls_back_to_configured_list(self, config_home):
        ...
        with patch("ev0_cli.models.fetch_api_models", return_value=[]), \
             patch("ev0_cli.curses_ui.curses_radiolist", side_effect=ImportError), \
             patch("builtins.input", return_value="2"), \
             patch("builtins.print"):
            _model_flow_named_custom({}, provider_info)

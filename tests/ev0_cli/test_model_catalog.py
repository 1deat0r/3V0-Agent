"""Tests for ev0_cli.model_catalog — remote manifest fetch + cache + fallback."""
...
def isolated_home(tmp_path, monkeypatch):
    ...
    import importlib
    from ev0_cli import model_catalog
...
class TestValidation:
    def test_accepts_well_formed_manifest(self, isolated_home):
        from ev0_cli.model_catalog import _validate_manifest
...
class TestDefaultModelFromCache:
    ...
    def test_shipped_manifest_labels_glm52_default(self, isolated_home):
        ...
        import ev0_cli.model_catalog as model_catalog
...
class TestIntegrationWithModelsModule:
    """Exercise the fallback paths via the real callers in ev0_cli.models."""
    ...
    def test_picker_nous_row_uses_curated_list(self, tmp_path, monkeypatch):
        ...
        import importlib
        from ev0_cli import model_catalog
        from ev0_cli.models import get_curated_nous_model_ids
        importlib.reload(model_catalog)
        try:
            from ev0_cli.model_switch import list_picker_providers
            ...
            with patch.object(
                model_catalog, "_fetch_manifest", return_value=_valid_manifest()
            ), patch("ev0_cli.models.check_nous_free_tier", return_value=False), patch(
                "ev0_cli.models.union_with_portal_free_recommendations",

...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`ev0_cli.slash_exec.EXECUTORS`, and
...
from ev0_cli.commands import COMMAND_REGISTRY, resolve_command
from ev0_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,

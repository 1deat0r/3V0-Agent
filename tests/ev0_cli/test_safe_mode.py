"""Tests for `3v0 chat --safe-mode` isolation."""
...
_VARS = ("EV0_SAFE_MODE", "EV0_IGNORE_USER_CONFIG", "EV0_IGNORE_RULES")
...
def test_cmd_chat_safe_mode_sets_env_before_startup(monkeypatch):
    ...
    def fake_has_provider() -> bool:
        assert os.environ["EV0_SAFE_MODE"] == "1"
        assert os.environ["EV0_IGNORE_USER_CONFIG"] == "1"
        assert os.environ["EV0_IGNORE_RULES"] == "1"
        return True

...
class TestSystemUnitHermesHome:
    ...
    def test_node_path_lookup_remains_fallback_without_managed_node(
        ...
        monkeypatch.setattr(
            "ev0_constants.iter_hermes_node_dirs", lambda root=None: []
        )
        monkeypatch.setattr(
            "ev0_constants.hermes_managed_node_tree_present",
...
class TestLegacyHermesUnitDetection:
    ...
    def test_accepts_alternate_execstart_formats(self, tmp_path, monkeypatch):
        ...
        variants = [
            ...
            "ExecStart=/venv/bin/python /opt/hermes/ev0_cli/main.py gateway run",

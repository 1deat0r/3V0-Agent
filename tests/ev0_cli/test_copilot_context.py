...
class TestGetCopilotModelContext:
    ...
    @patch("ev0_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("ev0_cli.models._urlopen_model_catalog_request")
    ...
    @patch("ev0_cli.models.fetch_github_model_catalog", return_value=[])

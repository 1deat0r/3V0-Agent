"""Tests for the shared byte formatter (ev0_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from ev0_cli.backup import _format_size as backup
    from ev0_cli.checkpoints import _fmt_bytes as checkpoints
    from ev0_cli.doctor import _human_bytes as doctor

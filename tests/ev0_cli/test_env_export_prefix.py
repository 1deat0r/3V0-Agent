...
hand-rolled parsers — ``ev0_cli.config.load_env``,
``ev0_cli.main._has_any_provider_configured``, and
...
def test_config_load_env_strips_export_prefix(tmp_path):
    from ev0_cli.config import invalidate_env_cache, load_env

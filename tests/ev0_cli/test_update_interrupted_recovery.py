...
def _stub_install_env(monkeypatch, m, seen):
    ...
    monkeypatch.setattr("ev0_cli.managed_uv.ensure_uv", lambda: None)
    # The install executor moved to ev0_cli._install_repair (shared between
    ...
    import ev0_cli._install_repair as ir

...
class TestNodeRuntimeNpmResolution:
    ...
    def test_update_rebuilds_desktop_that_disappears_mid_update(self):
        ...
        from ev0_cli import main as hm
        from ev0_cli import update_cmd
        ...
        desktop_build.assert_called_once_with(
            [hm.sys.executable, "-m", "ev0_cli.main", "desktop", "--build-only"],
            cwd=PROJECT_ROOT,
            env=ANY,
        )
    ...
    def test_git_failure_zip_fallback_rebuilds_missing_desktop(self, tmp_path, monkeypatch):
        ...
        with (
            ...
            patch("ev0_cli.managed_uv.ensure_uv", return_value="uv"),
            patch("ev0_cli.managed_uv.update_managed_uv"),
            patch(
            ...
            patch("ev0_cli.model_catalog.seed_cache_from_checkout", return_value=False),
        ):

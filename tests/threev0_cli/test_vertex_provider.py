...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (threev0_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_threev0_overlays():
    """threev0_cli.providers.get_provider("vertex") backs

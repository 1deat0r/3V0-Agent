"""Tests for threev0_cli.web_server and related config utilities."""
...
class TestWebServerEndpoints:
    ...
    def test_startup_eager_reconcile_never_raises(self, monkeypatch):
        ...
        monkeypatch.setattr(threev0_state, "SessionDB", boom)
    ...
    def test_heal_gives_up_when_reconcile_cannot_fix_the_store(self, monkeypatch):
        ...
        original_init = threev0_state.SessionDB.__init__
        ...
        # the class on threev0_state covers every open the helper makes.
        monkeypatch.setattr(threev0_state.SessionDB, "__init__", counting_init)
    ...
    def test_get_media_requires_auth(self):
        from threev0_cli.web_server import _SESSION_HEADER_NAME
    ...
    def test_platform_scoped_messaging_env_vars_are_channel_managed(self):
        ...
        tests/threev0_cli/test_setup_hidden_env.py.
        """
        from threev0_cli.web_server import (
    ...
    def test_reveal_env_var(self, tmp_path):
        ...
        from threev0_cli.web_server import _SESSION_HEADER_NAME, _SESSION_TOKEN
    ...
    def test_reveal_env_var_legacy_authorization_header_still_works(self, tmp_path):
        ...
        from threev0_cli.config import save_env_value
        from threev0_cli.web_server import _SESSION_TOKEN
    ...
    def test_parse_model_ids_handles_openai_and_bare_shapes(self):
        ...
        from threev0_cli.web_server import _parse_model_ids
    ...
    def test_deleting_the_active_custom_endpoint_clears_its_model_mirror(self):
        ...
        """
        from threev0_cli.config import custom_endpoint_key_env, get_env_value, load_config
    ...
    def test_custom_endpoint_save_leaves_a_hand_written_env_ref_alone(self, monkeypatch):
        ...
        from threev0_cli.config import custom_endpoint_key_env, get_config_path, get_env_value
    ...
    def test_two_endpoints_on_one_host_keep_separate_credentials(self):
        ...
        the first's key.
        """
        from threev0_cli.config import custom_endpoint_key_env, get_env_value
...
class TestBuildSchemaFromConfig:
    ...
    def test_overrides_applied(self):
        from threev0_cli.web_server import CONFIG_SCHEMA
    ...
    def test_timezone_field_is_searchable_select(self):
        ...
        """
        from threev0_cli.web_server import CONFIG_SCHEMA, _timezone_options
...
class TestConfigRoundTrip:
    ...
    def test_round_trip_preserves_schema_invisible_nested_keys(self):
        ...
        from threev0_cli.config import load_config, read_raw_config, save_config
...
class TestNewEndpoints:
    ...
    def test_get_toolset_config_reports_truthful_provider_status(self, monkeypatch):
        ...
        """
        import threev0_cli.tools_config as tools_config
        from threev0_cli.nous_account import NousPortalAccountInfo
...
class TestModelContextLength:
    ...
    def test_normalize_extracts_context_length_from_dict(self):
        ...
        from threev0_cli.web_server import _normalize_config_for_web
    ...
    def test_denormalize_writes_context_length_into_model_dict(self):
        ...
        from threev0_cli.web_server import _denormalize_config_from_web
...
class TestNormaliseThemeDefinition:
    ...
    def test_rejects_non_dict(self):
        from threev0_cli.web_server import _normalise_theme_definition
...
class TestBulkDeleteSessionsEndpoint:
    ...
    1. Route-ordering: ``/api/sessions/bulk-delete`` must shadow the
       ...
       the block comment in ``threev0_cli/web_server.py``).
    ...
    def test_route_order_not_shadowed_by_session_id(self):
        ...
        assert "deleted" in body, (
            ...
            "registration order in threev0_cli/web_server.py."
        )
...
class TestPtyWebSocket:
    ...
    def test_unavailable_platform_closes_with_message(self, monkeypatch):
        from threev0_cli.pty_bridge import PtyUnavailableError
        ...
        import threev0_cli.web_server as ws_mod
    ...
    def test_pub_broadcasts_to_events_subscribers(self):
        ...
        """
        import asyncio
        from threev0_cli import web_server as ws_mod

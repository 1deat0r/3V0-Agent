...
class TestGetCopilotModelContext:
    ...
    @patch("threev0_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("threev0_cli.models._urlopen_model_catalog_request")
    ...
    @patch("threev0_cli.models.fetch_github_model_catalog", return_value=[])

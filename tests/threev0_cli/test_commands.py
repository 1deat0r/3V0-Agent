...
class TestSlackAppManifest:
    """Generated Slack app manifest (used by `3v0 slack manifest`)."""
...
class TestSubcommandCompletion:
    ...
    def test_tools_enable_skips_already_listed(self, monkeypatch):
        ...
        monkeypatch.setattr(
            "threev0_cli.tools_config._get_plugin_toolset_keys",
            lambda: set(),
        )
...
from threev0_cli.commands import discord_skill_commands_by_category  # noqa: E402
...
class TestPluginCommandEnumeration:
    ...
    def _patch_plugin_commands(self, monkeypatch, commands):
        """Monkeypatch threev0_cli.plugins.get_plugin_commands() to a fixed dict."""
        from threev0_cli import plugins as _plugins_mod

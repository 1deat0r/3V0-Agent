...
Bug class: the checkout's ``.py`` files change (``3v0 update``, manual
...
def _make_pycache(repo: Path, subdir: str = "threev0_cli") -> Path:
...
# ---------------------------------------------------------------------------
# Plugin-update sibling site: __pycache__ under ~/.3V0/plugins/<name>
# ---------------------------------------------------------------------------

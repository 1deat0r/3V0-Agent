"""Tests for `3v0 curator status` output.
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated EV0_HOME with real agent-created skills on disk."""
    home = tmp_path / ".3V0"
    skills = home / "skills"
    ...
    from threev0_cli import curator as curator_cli
...
def test_adopt_subcommand_is_registered():
    ...
    import threev0_cli.curator as curator_cli

...
Every ``CommandDef`` with ``execute`` set must:
  * name a key that exists in :data:`threev0_cli.slash_exec.EXECUTORS`, and
...
from threev0_cli.commands import COMMAND_REGISTRY, resolve_command
from threev0_cli.slash_exec import (
    EXECUTORS,
    CommandContext,
    CommandReply,
    execute_command,

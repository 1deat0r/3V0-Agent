...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (threev0_cli/models.py)
# ---------------------------------------------------------------------------
...
class TestUpdateProviderCacheEntry:
    ...
    def test_writes_new_entry(self, tmp_path, monkeypatch):
        ...
        import threev0_cli.models as mod
...
# ---------------------------------------------------------------------------
# Parallel prefetch (threev0_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from threev0_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("threev0_cli.models._load_provider_models_cache", return_value=fresh_cache), \
             patch("threev0_cli.models._credential_fingerprint", return_value="fp"), \
             patch("threev0_cli.models.cached_provider_model_ids") as fetch:
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("threev0_cli.models._load_provider_models_cache", return_value=cache), \
             patch("threev0_cli.models._credential_fingerprint", return_value="fp_f"), \
             patch("threev0_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("threev0_cli.models.update_provider_cache_entry"):
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("threev0_cli.models._load_provider_models_cache", return_value={}), \
             patch("threev0_cli.models._credential_fingerprint", return_value="fp"), \
             patch("threev0_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("threev0_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("threev0_cli.models.cached_provider_model_ids") as fetch:
...
class TestPrefetchIntegration:
    ...
    def test_prefetch_called_with_more_than_3_providers(self):
        ...
        from threev0_cli import model_switch

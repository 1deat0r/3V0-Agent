...
Run: pytest tests/threev0_cli/test_dashboard_auth_native_flow.py
"""
...
from threev0_cli.dashboard_auth.base import Session
...
@pytest.fixture
def pw_gated_client():
    from threev0_cli.dashboard_auth.routes import _reset_password_rate_limit
    from tests.threev0_cli.test_dashboard_auth_password_login import (
        PasswordProvider,
    )

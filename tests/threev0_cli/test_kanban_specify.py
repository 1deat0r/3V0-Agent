"""Tests for the specifier module + `3v0 kanban specify` CLI surface.
...
from threev0_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `3v0 kanban …` argparse surface directly."""

...
def test_refresh_active_memory_provider_dependencies_reinstalls_active_provider(monkeypatch):
    ...
    monkeypatch.setattr(
        "threev0_cli.memory_setup._install_dependencies",
...
def test_reload_updated_runtime_modules_restores_new_threev0_constants_symbol(monkeypatch):
...
def test_bootstrap_marker_not_autostashed_by_update(tmp_path):
    ...
    # Exact flags used by 3v0 update (threev0_cli/main.py).

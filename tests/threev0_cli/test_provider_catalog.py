"""Tests for the unified provider catalog (threev0_cli.provider_catalog).

These are invariant tests, not snapshots: they assert the parity *contract*
between what ``3v0 model`` shows (``CANONICAL_PROVIDERS``) and what the
...
from threev0_cli.provider_catalog import (
    ProviderDescriptor,
    provider_catalog,

"""Regression: 3v0 doctor must not run a generic Bearer-auth health
...
with HTTP 404. The dedicated check at threev0_cli/doctor.py already covers
...
def test_build_apikey_providers_list_skips_dedicated_check_providers():
    from threev0_cli import doctor

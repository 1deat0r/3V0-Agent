"""Tests for `3v0 secrets bitwarden token` / `3v0 secrets onepassword token`.
...
from threev0_cli import onepassword_secrets_cli as op_cli
from threev0_cli import secrets_cli as bw_cli

"""Tests for the interactive session browser (`3v0 sessions browse`).
...
from threev0_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """3v0 sessions browse should be parseable."""

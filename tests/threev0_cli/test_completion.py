"""Tests for threev0_cli/completion.py — shell completion script generation."""
...
from threev0_cli.completion import _walk, generate_bash, generate_zsh, generate_fish

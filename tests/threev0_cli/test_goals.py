...
class TestGoalManager:
    ...
    def test_set_then_status(self, ev0_home):
    ...
    def test_continuation_prompt_shape(self, ev0_home):
...
class TestJudgeParseFailureAutoPause:
    ...
    def test_auto_pause_after_three_consecutive_parse_failures(self, ev0_home):
...
class TestMigrateGoalToSession:
    ...
    def test_migrates_active_goal_to_child(self, ev0_home):
    ...
    def test_does_not_clobber_existing_child_goal(self, ev0_home):
        from threev0_cli.goals import save_goal, load_goal, migrate_goal_to_session, GoalState
...
class TestGoalManagerSubgoals:
    def test_add_subgoal(self, ev0_home):
        from threev0_cli.goals import GoalManager
    ...
    def test_remove_subgoal_out_of_range(self, ev0_home):
        import pytest
        from threev0_cli.goals import GoalManager
...
class TestJudgeGoalWithSubgoals:
    def test_judge_uses_subgoals_template_when_provided(self, ev0_home):
    ...
    def test_judge_uses_original_template_when_no_subgoals(self, ev0_home):
        from unittest.mock import patch
        from threev0_cli import goals
...
class TestStatusLineSubgoalCount:
    ...
    def test_status_line_with_subgoals(self, ev0_home):
        from threev0_cli.goals import GoalManager
...
class TestWaitBarrier:
    ...
    def test_parked_on_live_pid_does_not_continue_or_judge(self, ev0_home):
        from threev0_cli import goals
        from threev0_cli.goals import GoalManager
    ...
    def test_stop_waiting_clears_barrier(self, ev0_home):
        from threev0_cli.goals import GoalManager
...
class TestJudgeDrivenWait:
    ...
    def test_judge_wait_pid_parks_loop(self, ev0_home):
        from threev0_cli import goals
        from threev0_cli.goals import GoalManager
    ...
    def test_time_barrier_clears_after_deadline(self, ev0_home):
        from threev0_cli.goals import GoalManager
    ...
    def test_continue_verdict_still_continues_with_background(self, ev0_home):
...
class TestSessionTriggerBarrier:
    ...
    def test_registry_releases_on_watch_match_while_alive(self, ev0_home):
    ...
    def test_wait_on_session_validation(self, ev0_home):
        from threev0_cli.goals import GoalManager
...
class TestGoalManagerContract:
    ...
    def test_set_contract_after_the_fact(self, ev0_home):
    ...
    def test_persistence_roundtrip(self, ev0_home):
        from threev0_cli.goals import GoalManager, GoalContract
...
class TestJudgeWithContract:
    ...
    def test_judge_uses_contract_template(self, ev0_home):
        from unittest.mock import patch
        from threev0_cli import goals
        from threev0_cli.goals import GoalContract
...
class TestDraftContract:
    def test_draft_parses_json(self, ev0_home):
        from unittest.mock import patch
        from threev0_cli import goals
    ...
    def test_draft_returns_none_when_no_client(self, ev0_home):
        from unittest.mock import patch
        from threev0_cli import goals
...
class TestContractAndBackgroundCompose:
    ...
    def test_judge_prompt_carries_contract_and_background(self, ev0_home):
        from unittest.mock import patch
        from threev0_cli import goals
        from threev0_cli.goals import GoalContract

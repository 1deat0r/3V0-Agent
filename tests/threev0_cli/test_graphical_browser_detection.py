"""Tests for `_can_open_graphical_browser()` in threev0_cli.auth.

Guards the fix for the May 2026 report where `3v0 auth add xai-oauth`
...
from threev0_cli.auth import _can_open_graphical_browser

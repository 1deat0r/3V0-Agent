...
def client(tmp_path, monkeypatch):
    ...
    monkeypatch.setenv("EV0_DASHBOARD_SESSION_TOKEN", "soul-test-token")
...
def profile_dir(tmp_path, monkeypatch) -> Path:
    """Create a real profile directory under the test EV0_HOME."""
    monkeypatch.setenv("EV0_HOME", str(tmp_path))
...
class TestSoulWriteDurability:
    ...
    def test_existing_soul_survives_an_interrupted_save(
        ...
        # EV0_HOME patch the client/profile_dir fixtures installed.

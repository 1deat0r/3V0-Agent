"""Tests for the Command Installation check in 3v0 doctor."""
...
import threev0_cli.doctor as doctor_mod


def _setup_doctor_env(monkeypatch, tmp_path, venv_name="venv"):
    """Create a minimal EV0_HOME + PROJECT_ROOT for doctor tests."""
    home = tmp_path / ".3V0"
...
class TestDoctorCommandInstallation:
    ...
    def test_fix_repairs_wrong_symlink(self, monkeypatch, tmp_path):
        ...
        cmd_link = cmd_link_dir / "3v0"
        wrong_target = tmp_path / "wrong_ev0"

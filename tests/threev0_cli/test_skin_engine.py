"""Tests for threev0_cli.skin_engine — the data-driven skin/theme system."""
...
def reset_skin_state():
    ...
    from threev0_cli import skin_engine
...
class TestSkinManagement:
    def test_set_active_skin(self):
        from threev0_cli.skin_engine import set_active_skin, get_active_skin, get_active_skin_name
...
class TestUserSkins:
    def test_load_user_skin_from_yaml(self, tmp_path, monkeypatch):
        ...
        # Patch skins dir
        monkeypatch.setattr("threev0_cli.skin_engine._skins_dir", lambda: skins_dir)
...
class TestDisplayIntegration:
    ...
    def test_tool_message_uses_skin_prefix(self):
        from threev0_cli.skin_engine import set_active_skin
...
class TestCliBrandingHelpers:
    ...
    def test_prompt_toolkit_style_overrides_use_skin_colors(self):
        from threev0_cli.skin_engine import (
            set_active_skin,
            get_active_skin,

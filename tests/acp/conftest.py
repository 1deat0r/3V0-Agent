...
Keeps the ACP server tests offline: ``Ev0ACPAgent._build_model_state``
calls ``threev0_cli.inventory.build_models_payload``, which (without this
...
def _offline_model_inventory(monkeypatch):
    ...
    import threev0_cli.inventory as inventory

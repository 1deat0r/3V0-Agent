"""Tests for ev0_constants module."""
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(ev0_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(ev0_constants, "_container_detected", True)
        assert is_container() is True
...
class TestResolvePerModelReasoningEffort:
    ...
    def test_exact_match(self):
        ...
        from ev0_constants import resolve_per_model_reasoning_effort
...
class TestAgentBrowserRunnable:
    ...
    def test_version_probe_uses_windows_hide_flags(self, tmp_path, monkeypatch):
        ...
        import ev0_cli._subprocess_compat as subprocess_compat
...
class TestWslPathTranslation:
    ...
    def test_windows_drive_to_wsl_mount(self):
        assert ev0_constants.windows_path_to_wsl(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert ev0_constants.windows_path_to_wsl("C:/Users/alex") == "/mnt/c/Users/alex"
        assert ev0_constants.windows_path_to_wsl("D:\\") == "/mnt/d/"

    def test_windows_drive_ignores_non_drive_paths(self):
        assert ev0_constants.windows_path_to_wsl("/home/alex") is None
        assert ev0_constants.windows_path_to_wsl("relative\\dir") is None
    ...
    def test_translate_maps_windows_and_unc_on_wsl(self, monkeypatch):
        ...
        assert ev0_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert ev0_constants.translate_cwd_for_wsl_backend(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        # Already-POSIX paths pass through untouched.
        assert ev0_constants.translate_cwd_for_wsl_backend("/home/alex") == "/home/alex"
...
class TestWindowsHealStageSwap:
    ...
    def _stub_env(
        ...
        monkeypatch.setattr(ev0_constants, "_managed_node_heal_attempted", False)
        monkeypatch.setattr(
            ev0_constants, "_managed_node_in_use_notice_printed", False
        )
        monkeypatch.setattr(
            ev0_constants,
        ...
        monkeypatch.setattr(
            ev0_constants, "node_tool_runnable", lambda path: True
        )

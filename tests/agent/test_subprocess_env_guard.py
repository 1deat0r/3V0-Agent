...
``ev0_subprocess_env`` / ``_sanitize_subprocess_env``, which the factory
...
``EV0_HOME`` or secret-scrub propagation.
...
ALLOWED_RAW_SPAWN_ENV_FILES = {
    # THE owner module: _sanitize_subprocess_env / ev0_subprocess_env /

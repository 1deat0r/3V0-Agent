...
from threev0_cli.observability.shared_metrics_contract import MODEL_ROUTE_METRIC
from threev0_cli.observability.shared_metrics_subscriber import SharedMetricsSubscriber


@pytest.fixture()
def relay_turn(tmp_path, monkeypatch):
    monkeypatch.setenv("EV0_HOME", str(tmp_path / "profile"))
...
def test_auxiliary_provider_fallback_records_one_terminal_model_route(
    ...
    assert snapshot[0]["resource"]["ev0_version"] == "test-version"

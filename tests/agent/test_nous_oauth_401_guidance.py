...
to a generic "Your API key was rejected... run 3v0 setup" message, which is
...
def test_nous_401_guidance_strings_present():
    ...
    # Must give a concrete re-auth command, not a generic "3v0 setup".
    assert "3v0 portal" in source

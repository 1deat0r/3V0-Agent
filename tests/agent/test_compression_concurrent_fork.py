...
Damien's incident (Discord, 2026-05-28): a long 3V0 session in a Discord
...
def _make_legacy_session_db_class() -> type:
    ...
    imports the same still-loaded ``threev0_state`` module, whose ``SessionDB``
    ...
    namespace = {"__name__": "threev0_state"}
    source = '''
class SessionDB:
...
_NominalSessionDBImpostor.__module__ = "threev0_state"

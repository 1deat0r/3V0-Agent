...
log lines comes from a SEPARATE mechanism — ``ev0_logging._session_context``
...
def test_logging_session_context_follows_compression_rotation(tmp_path: Path) -> None:
    ...
    ev0_logging.set_session_context(parent_sid)
    try:
        ...
        current = getattr(ev0_logging._session_context, "session_id", None)

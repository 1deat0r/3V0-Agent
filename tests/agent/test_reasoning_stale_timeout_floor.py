...
thinking phase.  3V0's default cloud-stream stale detector
(``EV0_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``EV0_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the

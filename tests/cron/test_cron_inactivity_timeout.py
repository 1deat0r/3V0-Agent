...
- Unlimited timeout (EV0_CRON_TIMEOUT=0)
- Backward compat: EV0_CRON_TIMEOUT env var still works
...
class TestInactivityTimeout:
    ...
    def test_unlimited_timeout(self):
        """EV0_CRON_TIMEOUT=0 means no timeout at all."""
        agent = FakeAgent(idle_seconds=0.0)
    ...
    def test_timeout_env_var_parsing(self, monkeypatch):
        """EV0_CRON_TIMEOUT env var is respected."""
        monkeypatch.setenv("EV0_CRON_TIMEOUT", "1200")

...
3V0 state stays profile-scoped through EV0_HOME. Host subprocesses should
...
See: https://github.com/NousResearch/3v0-agent/issues/25114
See: https://github.com/NousResearch/3v0-agent/issues/36144
See: https://github.com/NousResearch/3v0-agent/issues/29015
"""
...
class TestGetSubprocessHome:
    ...
    def test_two_profiles_get_different_homes(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setenv("EV0_HOME", str(base / "beta"))

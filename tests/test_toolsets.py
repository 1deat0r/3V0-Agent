...
class TestToolsetConsistency:
    ...
    def test_threev0_platforms_share_core_tools(self):
        ...
        on 3v0-discord, gated on DISCORD_BOT_TOKEN) are allowed on top —
        the invariant is that the core set is identical across platforms.
        """
        platforms = ["3v0-cli", "3v0-telegram", "3v0-discord", "3v0-whatsapp", "3v0-slack", "3v0-signal", "3v0-homeassistant"]
...
class TestResolveToolsetMemo:
    ...
    def test_second_resolution_is_cached(self, monkeypatch):
        ...
        first = resolve_toolset("3v0-cli")
        second = resolve_toolset("3v0-cli")
        ...
        assert (
            "3v0-cli", True, registry_id, generation
    ...
    def test_memo_result_matches_fresh_resolution(self):
        ...
        toolsets_mod._resolve_toolset_memo.clear()
        first = resolve_toolset("3v0-cli", include_registry=False)
        second = resolve_toolset("3v0-cli", include_registry=False)
        assert first == second

...
def test_registered_observable_metric_names_cover_snapshot_metrics(monkeypatch):
    ...
    gateway_snapshot = type("S", (), {"metrics": [
        _M("3v0.gateway.up"), _M("3v0.gateway.active_agents"),
        _M("3v0.gateway.busy"), _M("3v0.gateway.drainable"),
        _M("3v0.gateway.restart_requested"),
        _M("3v0.platform.up"), _M("3v0.platform.degraded"),
    ]})()
    cron_snapshot = type("S", (), {"metrics": [
        _M("3v0.cron.scheduler.heartbeat_age_seconds"),
        _M("3v0.cron.scheduler.last_success_age_seconds"),
        _M("3v0.cron.scheduler.catch_up_occurrences"),
        _M("3v0.cron.jobs.enabled"), _M("3v0.cron.jobs.running"),
        _M("3v0.cron.jobs.overdue"),
    ]})()
...
def test_monitoring_docs_distinguish_relay_health_scope_and_terminal_flush():
    ...
    assert "3V0 Agent-owned Relay transport health" in text

"""Tests for _setup_feishu() in ev0_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("ev0_cli.config.save_env_value", side_effect=mock_save), \
         patch("ev0_cli.config.get_env_value", side_effect=mock_get), \
         patch("ev0_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("ev0_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("ev0_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("ev0_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("ev0_cli.cli_output.print_header"), \
         patch("ev0_cli.cli_output.print_info"), \
         patch("ev0_cli.cli_output.print_success"), \
         patch("ev0_cli.cli_output.print_warning"), \
         patch("ev0_cli.cli_output.print_error"), \

"""Tests for _setup_feishu() in threev0_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("threev0_cli.config.save_env_value", side_effect=mock_save), \
         patch("threev0_cli.config.get_env_value", side_effect=mock_get), \
         patch("threev0_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("threev0_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("threev0_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("threev0_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("threev0_cli.cli_output.print_header"), \
         patch("threev0_cli.cli_output.print_info"), \
         patch("threev0_cli.cli_output.print_success"), \
         patch("threev0_cli.cli_output.print_warning"), \
         patch("threev0_cli.cli_output.print_error"), \

...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "ev0_approve_once" in action_ids
        assert "ev0_approve_session" in action_ids
        assert "ev0_approve_always" in action_ids
        assert "ev0_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_truncates_inflated_original_text(self):
        ...
        action = {"action_id": "ev0_approve_once", "value": "session-key"}

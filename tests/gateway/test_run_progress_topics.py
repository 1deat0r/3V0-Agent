...
class LongPreviewAgent:
    ...
    LONG_CMD = "cd /home/teknium/.3V0/3v0-agent/.worktrees/3v0-d8860339 && source .venv/bin/activate && python -m pytest tests/gateway/test_run_progress_topics.py -n0 -q"
...
class UrlPreviewAgent:
    URL = "https://github.com/1deat0r/3V0-Agent/docs/gateway/discord/tool-progress"
...
async def test_run_agent_progress_uses_event_message_id_for_slack_dm(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("EV0_TOOL_PROGRESS_MODE", "all")
...
async def test_terminal_progress_verbose_shows_full_command(monkeypatch, tmp_path):
    ...
    monkeypatch.setenv("EV0_TOOL_PROGRESS_MODE", "verbose")

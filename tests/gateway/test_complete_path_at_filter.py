...
def _reset_fuzzy_cache(monkeypatch):
    ...
    # via _load_cfg(), which resolves through _ev0_home captured at module
    # import time — before the per-test EV0_HOME redirect applies. When the

"""Tests for the secret-source tracking in ``ev0_cli.env_loader``.
...
def test_apply_external_secret_sources_dedupes_within_process(tmp_path, monkeypatch):
    ...
    hot modules (cli.py, ev0_cli/main.py, run_agent.py, ...).  The
    ...
    # cli.py, ev0_cli/main.py, run_agent.py, trajectory_compressor.py,

...
The unit tests in tests/threev0_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned 3v0-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/3v0")
from threev0_cli.service_manager import S6ServiceManager

...
def _fake_hooks(monkeypatch, results):
    ...
    monkeypatch.setattr("threev0_cli.plugins.invoke_hook", _invoke)
    return captured
...
def _no_hooks(monkeypatch):
    ...
    monkeypatch.setattr("threev0_cli.plugins.has_hook", lambda name: False)
    monkeypatch.setattr("threev0_cli.plugins.invoke_hook", _boom)

...
def _fake_hooks(monkeypatch, results):
    ...
    monkeypatch.setattr("ev0_cli.plugins.invoke_hook", _invoke)
    return captured
...
def _no_hooks(monkeypatch):
    ...
    monkeypatch.setattr("ev0_cli.plugins.has_hook", lambda name: False)
    monkeypatch.setattr("ev0_cli.plugins.invoke_hook", _boom)

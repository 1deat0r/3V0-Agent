"""Tests for ev0_subprocess_env() — the centralized credential-safe env
...
full credential environment. Two tiers:
  ...
  * Tier 2 (_EV0_PROVIDER_ENV_BLOCKLIST): LLM provider/tool keys — stripped
...
class TestDelegatedChildMarker:
    def test_delegated_child_context_scrubs_parent_kanban_keys_and_sets_marker(self):
        ...
        with patch.dict(
            ...
            {
                **_SAFE_SAMPLE,
                "EV0_KANBAN_TASK": "t_parent",
                "EV0_KANBAN_RUN_ID": "123",
                "EV0_KANBAN_DB": "/tmp/parent-kanban.db",
                "EV0_KANBAN_WORKSPACE": "/tmp/parent-workspace",
            },
            clear=True,
        ):

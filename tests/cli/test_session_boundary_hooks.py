...
from ev0_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/ev0_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("ev0_cli.lifecycle.invoke_hook")
@patch("ev0_cli.lifecycle.finalize_session")

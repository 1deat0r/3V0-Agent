...
from threev0_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/threev0_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("threev0_cli.lifecycle.invoke_hook")
@patch("threev0_cli.lifecycle.finalize_session")

"""Tests for the ``/reload-skills`` CLI slash command (``Ev0CLI._reload_skills``).
...
def _make_cli():
    """Build a minimal Ev0CLI shell exposing ``_reload_skills``."""
    import cli as cli_mod

    obj = object.__new__(cli_mod.Ev0CLI)

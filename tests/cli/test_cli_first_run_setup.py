...
def test_credentials_ready_false_when_no_provider(monkeypatch):
    ...
    monkeypatch.setattr("ev0_cli.runtime_provider.resolve_runtime_provider", _raise)
...
def test_offer_first_run_setup_routes_into_shared_picker(monkeypatch):
    ...
    monkeypatch.setattr("ev0_cli.main.select_provider_and_model", _fake_picker)
...
def test_offer_first_run_setup_declined(monkeypatch):
    ...
    monkeypatch.setattr("ev0_cli.main.select_provider_and_model", _fail_picker)
...
def test_offer_first_run_setup_picker_cancel_is_graceful(monkeypatch):
    ...
    monkeypatch.setattr("ev0_cli.main.select_provider_and_model", _cancel_picker)

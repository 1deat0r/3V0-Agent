"""Tests for threev0_constants module."""
...
class TestNodeToolRunnable:
    ...
    def test_outdated_managed_node_heals_to_target_major(self, tmp_path, monkeypatch):
        ...
        target = threev0_constants._EV0_NODE_TARGET_MAJOR
        profile_home = tmp_path / "profiles" / "assistant"
        managed_bin = profile_home / "node" / "bin"
        managed_bin.mkdir(parents=True)
        old_node = self._stub(
...
class TestIsContainer:
    ...
    def _reset_cache(self, monkeypatch):
        ...
        monkeypatch.setattr(threev0_constants, "_container_detected", None)
    ...
    def test_caches_result(self, monkeypatch):
        ...
        monkeypatch.setattr(threev0_constants, "_container_detected", True)
        assert is_container() is True
...
class TestResolvePerModelReasoningEffort:
    ...
    def test_exact_match(self):
        ...
        from threev0_constants import resolve_per_model_reasoning_effort
...
class TestAgentBrowserRunnable:
    ...
    def test_version_probe_uses_windows_hide_flags(self, tmp_path, monkeypatch):
        ...
        import threev0_cli._subprocess_compat as subprocess_compat
...
class TestWslPathTranslation:
    ...
    def test_windows_drive_to_wsl_mount(self):
        assert threev0_constants.windows_path_to_wsl(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert threev0_constants.windows_path_to_wsl("C:/Users/alex") == "/mnt/c/Users/alex"
        assert threev0_constants.windows_path_to_wsl("D:\\") == "/mnt/d/"

    def test_windows_drive_ignores_non_drive_paths(self):
        assert threev0_constants.windows_path_to_wsl("/home/alex") is None
        assert threev0_constants.windows_path_to_wsl("relative\\dir") is None
    ...
    def test_translate_maps_windows_and_unc_on_wsl(self, monkeypatch):
        ...
        assert threev0_constants.translate_cwd_for_wsl_backend(r"C:\Users\alex") == "/mnt/c/Users/alex"
        assert threev0_constants.translate_cwd_for_wsl_backend(r"\\wsl.localhost\Ubuntu\home\alex") == "/home/alex"
        # Already-POSIX paths pass through untouched.
        assert threev0_constants.translate_cwd_for_wsl_backend("/home/alex") == "/home/alex"
...
class TestManagedNodeTreeInUse:
    ...
    def _install_fake_psutil(self, monkeypatch, procs):
        ...
        monkeypatch.setattr(threev0_constants.sys, "platform", "win32")
    ...
    def test_always_false_off_windows(self, tmp_path, monkeypatch):
        monkeypatch.setattr(threev0_constants.sys, "platform", "darwin")
        monkeypatch.setenv("EV0_HOME", str(tmp_path))
        assert threev0_constants.managed_node_tree_in_use() is False
    ...
    def test_exe_under_node_dir_counts(self, tmp_path, monkeypatch):
        ...
        assert threev0_constants.managed_node_tree_in_use() is True
...
class TestWindowsHealStageSwap:
    ...
    def _stub_env(
        ...
        monkeypatch.setenv(
            ...
            str(threev0_constants._EV0_NODE_TARGET_MAJOR),
        )
        monkeypatch.setattr(threev0_constants, "_managed_node_heal_attempted", False)
        monkeypatch.setattr(
            threev0_constants, "_managed_node_in_use_notice_printed", False
        )
        monkeypatch.setattr(
            threev0_constants,
        ...
        monkeypatch.setattr(
            threev0_constants, "node_tool_runnable", lambda path: True
        )
    ...
    def test_in_use_defers_without_touching_tree(self, tmp_path, monkeypatch):
        ...
        zip_name, zip_bytes = _make_node_zip(threev0_constants._EV0_NODE_TARGET_MAJOR)
        ...
        result = threev0_constants._heal_managed_node_windows()

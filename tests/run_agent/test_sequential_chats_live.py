...
AlexKucera reported on Discord (2026-04-16) that after ``3v0 update`` pulled
...
Opt-in — not part of default CI:
    EV0_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v

Requires ``OPENROUTER_API_KEY`` to be set (or sourced via ~/.3V0/.env).
"""

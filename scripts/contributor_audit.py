...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^3V0\s+(Agent|Audit)$", re.IGNORECASE),
    ...
    re.compile(r".*\[bot\]$", re.IGNORECASE),             # any GitHub [bot] suffix (3v0-seaeye[bot] etc.)
...
IGNORED_EMAILS = {
    ...
    "3v0@nousresearch.com",
    "3v0-audit@example.com",

#!/usr/bin/env python3
"""Build the 3V0 Model Catalog — a centralized JSON manifest of curated models.
...
3V0 CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a 3V0 release.
...
from threev0_cli.models import (  # noqa: E402
    OPENROUTER_MODELS,
...
def build_catalog() -> dict:
    return {
        ...
        "metadata": {
            "source": "3v0-agent repo",
            "docs": "https://github.com/1deat0r/3V0-Agent/docs/reference/model-catalog",
        },
        "providers": {
            "openrouter": {
                "metadata": {
                    ...
                    "note": (
                        ...
                        'The entry labeled "default": true is the model 3V0 '

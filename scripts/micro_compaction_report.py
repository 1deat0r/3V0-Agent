#!/usr/bin/env python3
"""Summarize micro-compaction telemetry from 3V0 logs.
...
With no LOGFILE, reads ``$EV0_HOME/logs/agent.log`` (default ~/.3V0).
...
def default_log() -> Path:
    home = os.environ.get("EV0_HOME") or str(Path.home() / ".3V0")

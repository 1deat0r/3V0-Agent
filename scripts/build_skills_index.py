#!/usr/bin/env python3
"""Build the 3V0 Skills Index — a centralized JSON catalog of all skills.
...
`3v0 skills search/install` can use it without hitting the GitHub API.
...
# Ensure EV0_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building 3V0 Skills Index...", flush=True)

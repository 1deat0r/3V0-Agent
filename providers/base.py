...
def _profile_user_agent() -> str:
    """Return a ``3v0-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from threev0_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"3v0-cli/{_ver}"
    except Exception:
        return "3v0-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # 3v0-cli UA so the catalog endpoint is reachable.

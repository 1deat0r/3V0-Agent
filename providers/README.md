...
Registry and ABC for every inference provider 3V0 knows about.
...
`$EV0_HOME/plugins/model-providers/<name>/` (per-user overrides). The
...
under `$EV0_HOME/plugins/model-providers/` for a private plugin).

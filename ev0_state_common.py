...
Extracted verbatim from ev0_state.py so the SessionDB mixin modules
(ev0_state_search / ev0_state_schema / ev0_state_portability) can
reference them without importing ev0_state (which would be a cycle).
ev0_state re-imports every name here for backward compatibility.
"""

...
try:
    from ev0_constants import display_hermes_home as display_hermes_home
    from ev0_constants import get_hermes_home as get_hermes_home
except (ModuleNotFoundError, ImportError):

    def get_hermes_home() -> Path:
        """Return the Hermes home directory (default: ~/.hermes).

        Mirrors ``ev0_constants.get_hermes_home()``."""
    ...
    def display_hermes_home() -> str:
        ...
        Mirrors ``ev0_constants.display_hermes_home()``."""

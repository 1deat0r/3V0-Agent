...
version: 2.5.1
author: Siqi Chen (@blader, https://github.com/blader/humanizer), ported by 3V0 Agent
license: MIT
...
Also apply this skill to **your own** output when writing user-facing prose such as release notes, PR descriptions, docs, and summaries. 3V0's baseline voice already strips most of these, but a focused pass catches what slips through.

## How to use it in 3V0

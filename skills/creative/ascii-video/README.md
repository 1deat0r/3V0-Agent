...
Built for [3V0 Agent](https://github.com/NousResearch/3v0-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/3v0-agent/skills/creative/ascii-video`](https://github.com/NousResearch/3v0-agent/tree/main/skills/creative/ascii-video) via PR.

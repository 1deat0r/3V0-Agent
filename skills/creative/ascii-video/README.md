...
Built for [3V0 Agent](https://github.com/1deat0r/3V0-Agent). Usable in any coding agent. Canonical source lives here; synced to [`1deat0r/3V0-Agent/skills/creative/ascii-video`](https://github.com/1deat0r/3V0-Agent/tree/main/skills/creative/ascii-video) via PR.

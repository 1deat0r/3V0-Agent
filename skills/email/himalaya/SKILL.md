...
This skill is separate from the 3V0 Email gateway adapter. The gateway
adapter lets people email the agent and uses 3V0' built-in IMAP/SMTP
...
To reply non-interactively from 3V0, read the original message, compose a reply, and pipe it:
...
**Non-interactive (use this from 3V0)** — pipe the message via stdin:

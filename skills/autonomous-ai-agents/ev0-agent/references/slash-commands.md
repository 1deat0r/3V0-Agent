...
Registry of record: `threev0_cli/commands.py` (`COMMAND_REGISTRY`) — every
...
/snapshot [sub]          Create/restore 3V0 config+state snapshots (CLI)

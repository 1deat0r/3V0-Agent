/**
 * 3V0 desktop plugin template. Save as:
 *   <3v0 home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <3v0 home> is ~/.3V0 by default, or ~/.3V0/profiles/<name>
 * when running a named profile (`3v0 -p <name>`). Run `3v0 doctor` (or
 ...
 * Only these imports resolve: @3v0/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@3v0/plugin-sdk'

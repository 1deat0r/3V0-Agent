...
15. **What was the specific ModuleNotFoundError message caused by the wheel subpackage discovery trap in #34701?**  
   gold: `ModuleNotFoundError: No module named 'ev0_cli.dashboard_auth'`
...
3. **What specific file and line number were identified as the cause of an AssertionError (assert 56 == 55) in the Python tests?**  
   gold: `tests/ev0_cli/test_session_recovery_lost_and_found.py:327`
...
10. **What specific SQL update was added to the migration path in ev0_cli/kanban_db.py to prevent losing active wake on upgrade?**  

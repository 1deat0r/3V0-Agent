...
handlers delegate to the same `ev0_cli.profiles` primitives the REST
endpoints use.
...
def _(rid, params: dict) -> dict:
    ...
    # instead (ev0_cli.auth: profile reads fall back to the global
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                platform_enabled = set()
            try:
                from ev0_cli.tools_config import _DEFAULT_OFF_TOOLSETS
            except Exception:
            ...
            description = ""
            try:
                from ev0_cli.profiles import read_profile_meta
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if isinstance(params.get("description"), str):
            try:
                from ev0_cli.profiles import write_profile_meta

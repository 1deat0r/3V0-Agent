...
handlers delegate to the same `threev0_cli.profiles` primitives the REST
endpoints use.
...
def _(rid, params: dict) -> dict:
    ...
    # instead (threev0_cli.auth: profile reads fall back to the global
    ...
    try:
        ...
        try:
            ...
            try:
                ...
                platform_enabled = set()
            try:
                from threev0_cli.tools_config import _DEFAULT_OFF_TOOLSETS
            except Exception:
            ...
            description = ""
            try:
                from threev0_cli.profiles import read_profile_meta
...
def _(rid, params: dict) -> dict:
    ...
    try:
        ...
        if isinstance(params.get("description"), str):
            try:
                from threev0_cli.profiles import write_profile_meta

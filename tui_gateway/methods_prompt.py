...
def _(rid, params: dict) -> dict:
    ...
    # over another app when they are back in 3V0.
        ...
        if (
            ...
            if not is_truthy_value(params.get("confirm_truncate")):
                ...
                return _err(
                    ...
                    "(update your 3V0 client if a rewind was intended)",
                )
...
def _(rid, params: dict) -> dict:
    ...
    def run():
        ...
        try:
            ...
            # EV0_HOME override (the ContextVar set on the session-create
...
def _(rid, params: dict) -> dict:
    ...
    prompt = "\n".join(
        ...
        for line in [
            ...
            "Restart exactly the app intended for the Preview URL, not 3V0 Desktop itself.",
            ...
            "First inspect what process, if any, owns the Preview URL port. If a stale server exists, inspect its cwd and prefer that cwd over the 3V0/Desktop process cwd.",
            ...
            "Before declaring success, verify the Preview URL responds with the intended app, not 3V0 Desktop. If it serves 3V0/Desktop UI or another unrelated app, stop that process and report failure.",
    ...
    def run():
        ...
        try:
            ...
            # the session's EV0_HOME override (the ContextVar set on the
...
def _(rid, params: dict) -> dict:
    # `text` is a JSON string describing the OS window underneath the 3V0

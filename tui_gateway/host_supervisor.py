...
def _default_registry_path() -> Path:
    return get_ev0_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_ev0_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_ev0_home = expected_ev0_home if expected_ev0_home is not None else str(get_ev0_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_ev0_home:
            raise RuntimeError(f"compute host EV0_HOME mismatch: {got_home} != {self.expected_ev0_home}")

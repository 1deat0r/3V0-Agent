import { Box, type ScrollBoxHandle, stringWidth, Text } from '@ev0/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (EV0_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (EV0_DEV_CREDITS), lowest priority,

...
//
// Both gate on EV0_DEV_PERF=1 and dump JSON-lines (default ~/.3V0/perf.log,
// override EV0_DEV_PERF_LOG). Tagged { src: 'react' | 'frame' } for jq.
// EV0_DEV_PERF_MS (default 2) skips sub-ms idle frames; set 0 to capture all.
//
...
const THRESHOLD_MS = Number(process.env.EV0_DEV_PERF_MS ?? '2') || 0
const LOG_PATH = process.env.EV0_DEV_PERF_LOG?.trim() || join(homedir(), '.3V0', 'perf.log')

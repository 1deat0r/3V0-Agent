...
await build({
  ...
  // Skip the prebuilt @3v0/ink bundle and inline the source instead:
  ...
  alias: { '@3v0/ink': resolve(root, 'packages/3v0-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The threev0_cli launcher

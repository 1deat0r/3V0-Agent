...
await build({
  ...
  // Skip the prebuilt @ev0/ink bundle and inline the source instead:
  ...
  alias: { '@ev0/ink': resolve(root, 'packages/ev0-ink/src/entry-exports.ts') },
...
// the `node` token, leaving a broken interpreter). The ev0_cli launcher
